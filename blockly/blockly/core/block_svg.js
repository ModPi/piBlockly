...
Blockly.BlockSvg.NOTCH_WIDTH = 0;
/**
...
Blockly.BlockSvg.NOTCH_PATH_LEFT = 'l 0,0 0,0 0,0';
/**
...
Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT = 'l 0,0 0,0 0,0';
/**
 * SVG path for drawing next/previous notch from right to left.
 * @const
 */
//Blockly.BlockSvg.NOTCH_PATH_RIGHT = 'l -6,4 -3,0 -6,-4';
Blockly.BlockSvg.NOTCH_PATH_RIGHT = 'l 0,0 0,0 0,0';
/**
...
Blockly.BlockSvg.TAB_PATH_DOWN = 'v 5 h -5 v 15 h 5'
/*
...
Blockly.BlockSvg.INNER_TOP_LEFT_CORNER = "l 0,0 0,0 0,0 h 0 a 2,2 0 0,0 -2,2"
/*
...
Blockly.BlockSvg.prototype.updateColour = function() {
  ...
  var rgbLight = rgb; //goog.color.lighten(rgb, 0.3);
  var rgbDark = rgb; //goog.color.darken(rgb, 0.4);
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(steps, highlightSteps,
  ...
  if (this.block_.outputConnection) {
    ...
    // This connection will be tightened when the parent renders.
    steps.push('V', 0);
    steps.push('v 5 h -5 v 15 h 5');
    /*
    steps.push('V', Blockly.BlockSvg.TAB_HEIGHT);
    steps.push('c 0,-100 -' + Blockly.BlockSvg.TAB_WIDTH + ',8 -' +
