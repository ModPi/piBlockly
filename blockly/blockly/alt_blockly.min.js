...
goog.userAgent.DOCUMENT_MODE=function(){var a=goog.global.document;return a&&goog.userAgent.IE?goog.userAgent.getDocumentMode_()||("CSS1Compat"==a.compatMode?parseInt(goog.userAgent.VERSION,10):5):void 0}();var Blockly={Helper:function(){this.translate=function(a,b,c){a.setAttribute("transform","translate("+b+", "+c+")")};this.adjustRectangle=function(a,b,c,d,e){a.setAttribute("x",b);a.setAttribute("y",c);a.setAttribute("width",d);a.setAttribute("height",e)};this.adjustText=function(a,b,c,d){var e=a.getBBox(),f=e.width/2;"left"==d&&(f=0);a.setAttribute("x",b-f);a.setAttribute("y",c+e.height/4)};this.prepareConnection=function(a,b,c,d){a.prepareConnection(b,c,d)};this.moveAndTightenConnection=function(a,
b,c){a.connection.moveTo(b,c);a.connection.targetConnection&&a.connection.tighten_()};this.setPath=function(a,b){a.setAttribute("d",b.toString())};this.getRowHeight=function(a){var b=Blockly.Builder.LINE_HEIGHT;a.connection.targetConnection&&(b=a.connection.targetBlock().getHeightWidth().height);return b};this.cutoutInlineInputs=function(a){a.svg_.svgPath_.setAttribute("fill-rule","evenodd")}}};Blockly.Builder=function(){var a=[],b,c;b=c=0;this.moveTo=function(d,e){a.push("M"+d+","+e);b=d;c=e};this.drawHorizontallyTo=function(c){a.push("H"+c);b=c};this.drawHorizontallyBy=function(c){a.push("h"+c);b+=c};this.drawIncomingConnection=function(){var c=Blockly.Builder.CONNECTION_WIDTH/2;a.push(["l",c,",",Blockly.Builder.CONNECTION_DEPTH," ",c,",",-1*Blockly.Builder.CONNECTION_DEPTH].join(""));b+=Blockly.Builder.CONNECTION_WIDTH};this.drawOutgoingConnection=function(){var c=Blockly.Builder.CONNECTION_WIDTH/
2*-1;a.push(["l",c,",",Blockly.Builder.CONNECTION_DEPTH," ",c,",",-1*Blockly.Builder.CONNECTION_DEPTH].join(""));b-=Blockly.Builder.CONNECTION_WIDTH};this.drawVerticallyBy=function(b){a.push("v"+b);c+=b};this.drawVerticallyTo=function(b){a.push("V"+b);c=b};this.drawInput=function(){var b=(Blockly.Builder.INPUT_HEIGHT-(Blockly.Builder.LINE_HEIGHT-2*Blockly.Builder.INPUT_INSET))/2;a.push(["v",Blockly.Builder.INPUT_INSET,"l",-1*Blockly.Builder.INPUT_DEPTH,",",-1*b,"v",Blockly.Builder.INPUT_HEIGHT,"l",
Blockly.Builder.INPUT_DEPTH,",",-1*b,"v",Blockly.Builder.INPUT_INSET].join(""));c+=Blockly.Builder.LINE_HEIGHT};this.drawVerticalInput=function(){var c=(Blockly.Builder.INPUT_HEIGHT-(Blockly.Builder.LINE_HEIGHT-2*Blockly.Builder.INPUT_INSET))/2;a.push(["h",-1*Blockly.Builder.INPUT_INSET,"l",c,",",Blockly.Builder.INPUT_DEPTH,"h",-1*Blockly.Builder.INPUT_HEIGHT,"l",c,",",-1*Blockly.Builder.INPUT_DEPTH,"h",-1*Blockly.Builder.INPUT_INSET].join(""));b+=Blockly.Builder.STATEMENT_ARM_WIDTH-Blockly.Builder.LINE_HEIGHT};
this.drawConnectionTrapezoid=function(c,e,f){var g,h=Blockly.Builder.CONNECTION_TRAPEZOID_INSET,k=Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH,l=Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH;f=void 0!==f?f:-1;"vertical"==c?"input"==e?(g=["h",-1*h,"l",h+f,",",k,"h",-1*l,"l",h+f,",",-1*k,"h",-1*h],b-=l):"output"==e&&(g=["h",h,"l",-1*h,",",k,"h",l,"l",-1*h,",",-1*k,"h",h],b+=l):"horizontal"==c&&("input"==e?g=["v",-1*h,"l",-1*k,",",h,"v",-1*l,"l",k,",",h,"v",-1*h]:"output"==e&&(g=["v",-1*h,"l",-1*k,",",h,
"v",-1*l,"l",k,",",h,"v",-1*h]));a.push(g.join(""))};this.drawConnectionBox=function(b,c){var f,g=Blockly.Builder.CONNECTION_BOX_INSET,h=Blockly.Builder.CONNECTION_BOX_HEIGHT;"vertical"!=b&&"horizontal"==b&&"input"==c&&(f=["h",g,"v",-1*h,"h",-1*g]);a.push(f.join(""))};this.drawConnectionDoubleBox=function(c){var e=Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT,f=Blockly.Builder.CONNECTION_DOUBLEBOX_WIDTH,g;"input"==c?(g=["v",e,"h",-1*f,"v",-1*e,"h",-1*f,"v",e,"h",-1*f,"v",-1*e],b-=Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH):
"output"==c&&(g=["v",e,"h",f,"v",-1*e,"h",f,"v",e,"h",f,"v",-1*e],b+=Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH);a.push(g.join(""))};this.drawConnectionTriangle=function(c){var e,f;e=Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT;"input"==c?(f=-1*Blockly.Builder.CONNECTION_TRIANGLE_INSET,b-=Blockly.Builder.CONNECTION_TRIANGLE_WIDTH):"output"==c&&(f=Blockly.Builder.CONNECTION_TRIANGLE_INSET,b+=Blockly.Builder.CONNECTION_TRIANGLE_WIDTH);a.push(["l",f,",",e," ",f,",",-1*e].join(""))};this.drawConnectionInlineTrapezoid=
function(){var b=Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT,c=Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH,f=b/2-Math.round(Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH/2);a.push(["h",c,"v",b,"h",-1*c,"v",-1*f].join(""));this.drawConnectionTrapezoid("horizontal","input");this.closePath()};this.drawConnectionInlineBox=function(){var b=Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT,c=Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH,f=b/2-Math.round(Blockly.Builder.CONNECTION_BOX_HEIGHT/2);a.push(["h",
c,"v",b,"h",-1*c,"v",-1*f].join(""));this.drawConnectionBox("horizontal","input");this.closePath()};this.drawConnectionInlineString=function(){var b=Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT,c=Blockly.Builder.DEFAULT_STRING_BLOCK_WIDTH,f=Blockly.Builder.CONNECTION_TRIANGLE_INSET,g=Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT;a.push(["h",c,"v",b,"h",-1*c,"v",-1*(b/2-f),"l",-1*g,",",-1*f," ",g,",",-1*f].join(""));this.closePath()};this.drawOutput=function(){var b=(Blockly.Builder.INPUT_HEIGHT-
(Blockly.Builder.LINE_HEIGHT-2*Blockly.Builder.INPUT_INSET))/2;a.push(["v",-1*Blockly.Builder.INPUT_INSET,"l",-1*Blockly.Builder.INPUT_DEPTH,",",b,"v",-1*Blockly.Builder.INPUT_HEIGHT,"l",Blockly.Builder.INPUT_DEPTH,",",b,"v",-1*Blockly.Builder.INPUT_INSET].join(""));c+=Blockly.Builder.LINE_HEIGHT};this.drawVerticalOutput=function(){var c=(Blockly.Builder.INPUT_HEIGHT-(Blockly.Builder.LINE_HEIGHT-2*Blockly.Builder.INPUT_INSET))/2;a.push(["l",-1*c,",",Blockly.Builder.INPUT_DEPTH,"h",Blockly.Builder.INPUT_HEIGHT,
"l",-1*c,",",-1*Blockly.Builder.INPUT_DEPTH].join(""));b+=Blockly.Builder.INPUT_HEIGHT-2*c};this.drawStatementGutter=function(a,b){this.drawVerticallyBy(a);this.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);"triangle"==b?this.drawConnectionTriangle("output"):"doublebox"==b&&this.drawConnectionDoubleBox("output")};this.closePath=function(){a.push("z")};this.toString=function(){return a.join("")};this.getCurrentPosition=function(){return{x:b,y:c}}};Blockly.Builder.CONNECTION_INSET=20;
Blockly.Builder.CONNECTION_WIDTH=20;Blockly.Builder.CONNECTION_DEPTH=10;Blockly.Builder.INPUT_INSET=5;Blockly.Builder.INPUT_HEIGHT=20;Blockly.Builder.INPUT_DEPTH=8;Blockly.Builder.PADDING_TOP=24;Blockly.Builder.PADDING_BOTTOM=12;Blockly.Builder.LINE_HEIGHT=26;Blockly.Builder.LINE_SPACING=12;Blockly.Builder.OUTPUT_INSET=Blockly.Builder.PADDING_TOP+3.4*Blockly.Builder.LINE_HEIGHT+Blockly.Builder.LINE_SPACING;Blockly.Builder.STATEMENT_ARM_WIDTH=10;Blockly.Builder.STATEMENT_ARM_LENGTH=180;
Blockly.Builder.MINIMUM_STATEMENT_ARM_HEIGHT=90;Blockly.Builder.TITLE_SPACING=10;Blockly.Builder.MINIMUM_FIELD_WIDTH=33;Blockly.Builder.DROPDOWN_WIDTH=133;Blockly.Builder.HORIZONTAL_FIELD_PADDING=10;Blockly.Builder.VERTICAL_FIELD_PADDING=4;Blockly.Builder.STATEMENT_TITLE_OFFSET=14;Blockly.Builder.STATEMENT_LEFT_ALIGN=20;Blockly.Builder.SINGLE_LINE_INPUT_HEIGHT=30;Blockly.Builder.SINGLE_LINE_INPUT_PADDING=5;Blockly.Builder.SHAPE_BLOCK_PADDING_TOP=20;Blockly.Builder.CHALLENGE_BLOCK_TITLE_HEIGHT=40;
Blockly.Builder.INPUT_TITLE_LABEL_STYLE="font-family: 'Open Sans', sans-serif; font-size: 13px; text-transform: uppercase; kerning: 1px; font-weight: normal; fill: #eeecf1;";Blockly.Builder.FONT_SIZE=12;Blockly.Builder.FONT_WEIGHT=400;Blockly.Builder.WORD_SPACING=-1;Blockly.Builder.BLOCK_BACK_WIDTH=10;Blockly.Builder.DEFAULT_BLOCK_PADDING=10;Blockly.Builder.BLOCK_ARM_HEIGHT=20;Blockly.Builder.BLOCK_DEFAULT_GUTTER_HEIGHT=90;Blockly.Builder.BLOCK_GUTTER_BOTTOM_PADDING=30;
Blockly.Builder.BLOCK_TITLE_INDENT=Blockly.Builder.BLOCK_BACK_WIDTH;Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT=25;Blockly.Builder.BLOCK_TITLE_HEIGHT=40;Blockly.Builder.CONNECTION_INDENT=25;Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH=15;Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH=8;Blockly.Builder.CONNECTION_TRAPEZOID_INSET=2;Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH=37;Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT=30;Blockly.Builder.CONNECTION_TRIANGLE_INSET=8;
Blockly.Builder.CONNECTION_TRIANGLE_WIDTH=2*Blockly.Builder.CONNECTION_TRIANGLE_INSET;Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT=8;Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT=5;Blockly.Builder.CONNECTION_DOUBLEBOX_WIDTH=8;Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH=3*Blockly.Builder.CONNECTION_DOUBLEBOX_WIDTH;Blockly.Builder.CONNECTION_BOX_INSET=5;Blockly.Builder.CONNECTION_BOX_HEIGHT=8;Blockly.Builder.DEFAULT_STRING_BLOCK_WIDTH=170;Blockly.RenderStrategies=[];Blockly.trace=function(a){for(var b=a.block_.getConnections_(),c=0,d;d=b[c];c++)Blockly.createSvgElement("circle",{cx:d.x_,cy:d.y_,r:5,stroke:"red",fill:"transparent"},a.svgGroup_)};Blockly.BlockSvg=function(a){this.block_=a;this.svgGroup_=Blockly.createSvgElement("g",{},null);this.svgPath_=Blockly.createSvgElement("path",{"class":"blocklyPath"},this.svgGroup_);this.helper_=new Blockly.Helper;this.updateMovable()};Blockly.BlockSvg.INLINE=-1;
Blockly.BlockSvg.prototype.init=function(){var a=this.block_;this.updateColour();for(var b=0,c;c=a.inputList[b];b++)c.init()};Blockly.BlockSvg.prototype.updateMovable=function(){this.block_.isMovable()?Blockly.addClass_(this.svgGroup_,"blocklyDraggable"):Blockly.removeClass_(this.svgGroup_,"blocklyDraggable")};Blockly.BlockSvg.prototype.getRootElement=function(){return this.svgGroup_};Blockly.BlockSvg.SEP_SPACE_X=10;Blockly.BlockSvg.SEP_SPACE_Y=20;Blockly.BlockSvg.INLINE_PADDING_Y=5;
Blockly.BlockSvg.PADDING_TOP=26;Blockly.BlockSvg.PADDING_BOTTOM=26;Blockly.BlockSvg.MIN_BLOCK_Y=25;Blockly.BlockSvg.TAB_HEIGHT=20;Blockly.BlockSvg.TAB_WIDTH=8;Blockly.BlockSvg.NOTCH_WIDTH=20;Blockly.BlockSvg.CONNECTION_INSET=40;Blockly.BlockSvg.CORNER_RADIUS=8;Blockly.BlockSvg.TITLE_HEIGHT=18;Blockly.BlockSvg.DISTANCE_45_INSIDE=(1-Math.SQRT1_2)*(Blockly.BlockSvg.CORNER_RADIUS-1)+1;Blockly.BlockSvg.DISTANCE_45_OUTSIDE=(1-Math.SQRT1_2)*(Blockly.BlockSvg.CORNER_RADIUS+1)-1;
Blockly.BlockSvg.NOTCH_PATH_LEFT="l 10,10 10,-10";Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT="l 6.5,4 2,0 6.5,-4";Blockly.BlockSvg.NOTCH_PATH_RIGHT="l -10,10 -10,-10";Blockly.BlockSvg.JAGGED_TEETH="l 8,0 0,4 8,4 -16,8 8,4";Blockly.BlockSvg.JAGGED_TEETH_HEIGHT=20;Blockly.BlockSvg.TAB_PATH_DOWN="v 5 c 0,10 -"+Blockly.BlockSvg.TAB_WIDTH+",-8 -"+Blockly.BlockSvg.TAB_WIDTH+",7.5 s "+Blockly.BlockSvg.TAB_WIDTH+",-2.5 "+Blockly.BlockSvg.TAB_WIDTH+",7.5";Blockly.BlockSvg.TAB_PATH_DOWN="l -8,-2 v 20 l 8,-2";
...
Blockly.BlockSvg.prototype.connectionUiEffect=function(){Blockly.playAudio("click");var a=Blockly.getSvgXY_(this.svgGroup_);this.block_.outputConnection?(a.x+=Blockly.RTL?3:-3,a.y+=13):this.block_.previousConnection&&(a.x+=Blockly.RTL?-23:23,a.y+=3)};Blockly.BlockSvg.connectionUiStep_=function(a){var b=(new Date-a.startDate_)/150;1<b?goog.dom.removeNode(a):(a.setAttribute("r",25*b),a.style.opacity=1-b,window.setTimeout(function(){Blockly.BlockSvg.connectionUiStep_(a)},10))};
Blockly.BlockSvg.prototype.updateColour=function(){var a;this.block_.disabled||(isNaN(this.block_.getColour())?a=this.block_.getColour():(a=Blockly.makeColour(this.block_.getColour()),goog.color.hexToRgb(a)),this.svgPath_.setAttribute("fill",a))};
...
Blockly.BlockSvg.prototype.render=function(){var a=this.block_,b=new Blockly.Builder,c=new Blockly.Helper;b.moveTo(0,0);Blockly.RenderStrategies[a.desiredStrategy](a,b,c);c.setPath(this.svgPath_,b);a.rendered=!0;(a=this.block_.getParent())&&a.render()};Blockly.Blocks={};Blockly.ScrollbarPair=function(a){this.workspace_=a;this.oldHostMetrics_=null;this.vScroll=new Blockly.Scrollbar(a,!1,!0);Blockly.addChangeListener(function(){Blockly.svgResize()})};Blockly.ScrollbarPair.prototype.dispose=function(){Blockly.unbindEvent_(this.onResizeWrapper_);this.onResizeWrapper_=null;goog.dom.removeNode(this.corner_);this.oldHostMetrics_=this.workspace_=null;this.vScroll.dispose();this.vScroll=null};
Blockly.ScrollbarPair.prototype.resize=function(){var a=Blockly.getMainWorkspaceMetrics_();if(a){var b=!1;this.oldHostMetrics_&&this.oldHostMetrics_.viewWidth==a.viewWidth&&this.oldHostMetrics_.viewHeight==a.viewHeight&&this.oldHostMetrics_.absoluteTop==a.absoluteTop&&this.oldHostMetrics_.absoluteLeft==a.absoluteLeft?this.oldHostMetrics_&&this.oldHostMetrics_.contentHeight==a.contentHeight&&this.oldHostMetrics_.viewTop==a.viewTop&&this.oldHostMetrics_.contentTop==a.contentTop||(b=!0):b=!0;b&&this.vScroll.resize(a);
this.oldHostMetrics_=a}};Blockly.ScrollbarPair.prototype.set=function(a,b){if(Blockly.Scrollbar===Blockly.ScrollbarNative){this.vScroll.set(b,!1);var c={x:0};c.y=this.vScroll.outerDiv_.scrollTop/this.vScroll.innerImg_.offsetHeight||0;this.workspace_.setMetrics(c)}else this.vScroll.set(b,!0)};Blockly.ScrollbarInterface=function(){};Blockly.ScrollbarInterface.prototype.dispose=function(){};Blockly.ScrollbarInterface.prototype.resize=function(){};Blockly.ScrollbarInterface.prototype.isVisible=function(){};
Blockly.ScrollbarInterface.prototype.setVisible=function(a){};Blockly.ScrollbarInterface.prototype.set=function(a,b){};
...
Blockly.ScrollbarSvg.prototype.resize=function(a){if(!a&&(a=this.workspace_.getMetrics(),!a))return;this.ratio_=a.viewHeight/a.contentHeight;if(-Infinity===this.ratio_||Infinity===this.ratio_||isNaN(this.ratio_))this.ratio_=0;var b=parseInt(this.svgKnob_.getAttribute("y"));if(-Infinity==b||Infinity==b||isNaN(b))b=0;var c=a.viewHeight*this.ratio_,d=(a.viewTop-a.contentTop)*this.ratio_;log("Content height:",a.contentHeight);log("Ratio:",this.ratio_);log("Inner length:",c);log("Position:",b);this.svgKnob_.setAttribute("height",
Math.max(0,c));this.xCoordinate=a.absoluteLeft+a.viewWidth-Blockly.Scrollbar.scrollbarThickness;this.yCoordinate=a.absoluteTop;this.svgGroup_.setAttribute("transform","translate("+this.xCoordinate+", "+this.yCoordinate+")");this.svgBackground_.setAttribute("height",a.viewHeight);this.svgKnob_.setAttribute("y",this.constrainKnob_(d))};
...
Blockly.ScrollbarSvg.prototype.onScroll_=function(){var a=parseFloat(this.svgKnob_.getAttribute(this.horizontal_?"x":"y")),b=parseFloat(this.svgBackground_.getAttribute(this.horizontal_?"width":"height")),a=a/(b-this.svgKnob_.getAttribute("height"));isNaN(a)&&(a=0);a=Math.min(1,a);b={};this.horizontal_?b.x=a:b.y=a;this.workspace_.setMetrics(b)};
Blockly.ScrollbarSvg.prototype.set=function(a,b){if(!this.horizontal_){var c=this.svgBackground_.getAttribute("height")-this.svgKnob_.getAttribute("height");a=Math.min(a,c)}this.svgKnob_.setAttribute(this.horizontal_?"x":"y",a);if(b)this.onScroll_()};goog.userAgent.GECKO&&(goog.userAgent.MAC||goog.userAgent.LINUX)?(Blockly.Scrollbar=Blockly.ScrollbarNative,Blockly.Scrollbar.scrollbarThickness=0):(Blockly.Scrollbar=Blockly.ScrollbarSvg,Blockly.Scrollbar.scrollbarThickness=15);
Blockly.Scrollbar.insertAfter_=function(a,b){var c=b.nextSibling,d=b.parentNode;if(!d)throw"Reference node has no parent.";c?d.insertBefore(a,c):d.appendChild(a)};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(goog.Disposable.INCLUDE_STACK_ON_CREATION&&(this.creationStack=Error().stack),goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.INCLUDE_STACK_ON_CREATION=!0;goog.Disposable.instances_={};
...
goog.Timer.callOnce=function(a,b,c){if(goog.isFunction(a))c&&(a=goog.bind(a,c));else if(a&&"function"==typeof a.handleEvent)a=goog.bind(a.handleEvent,a);else throw Error("Invalid listener argument");return b>goog.Timer.MAX_TIMEOUT_?-1:goog.Timer.defaultTimerObject.setTimeout(a,b||0)};goog.Timer.clear=function(a){goog.Timer.defaultTimerObject.clearTimeout(a)};Blockly.Trashcan=function(a){this.workspace_=a};Blockly.Trashcan.prototype.BODY_URL_="media/trashcan.svg";Blockly.Trashcan.prototype.LID_URL_="";Blockly.Trashcan.prototype.WIDTH_=28;Blockly.Trashcan.prototype.BODY_HEIGHT_=28;Blockly.Trashcan.prototype.LID_HEIGHT_=5;Blockly.Trashcan.prototype.MARGIN_BOTTOM_=15;Blockly.Trashcan.prototype.MARGIN_SIDE_=14;Blockly.Trashcan.prototype.isOpen=!1;Blockly.Trashcan.prototype.svgGroup_=null;Blockly.Trashcan.prototype.svgBody_=null;
...
Blockly.Trashcan.prototype.createDom=function(){this.svgGroup_=Blockly.createSvgElement("g",{},null);this.svgBody_=Blockly.createSvgElement("image",{width:this.WIDTH_,height:this.BODY_HEIGHT_},this.svgGroup_);this.svgBody_.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",Blockly.pathToBlockly+this.BODY_URL_);this.svgBody_.setAttribute("class","trashcan");this.beingTouched=!1;var a=this;this.svgBody_.onclick=function(b){a.clearWorkspace()};this.svgBody_.addEventListener("touchstart",function(b){a.beingTouched=
!0});this.svgBody_.addEventListener("touchend",function(b){a.beingTouched&&a.clearWorkspace()});return this.svgGroup_};Blockly.Trashcan.prototype.init=function(){this.setOpen_(!1);this.position_();Blockly.bindEvent_(window,"resize",this,this.position_)};Blockly.Trashcan.prototype.dispose=function(){this.svgGroup_&&(goog.dom.removeNode(this.svgGroup_),this.svgGroup_=null);this.workspace_=this.svgLid_=this.svgBody_=null;goog.Timer.clear(this.lidTask_)};
Blockly.Trashcan.prototype.position_=function(){var a=this.workspace_.getMetrics();a&&(this.left_=Blockly.RTL?this.MARGIN_SIDE_:a.viewWidth+a.absoluteLeft-this.WIDTH_-this.MARGIN_SIDE_,this.top_=a.viewHeight+a.absoluteTop-(this.BODY_HEIGHT_+this.LID_HEIGHT_)-this.MARGIN_BOTTOM_,this.svgGroup_.setAttribute("transform","translate("+this.left_+","+this.top_+")"))};Blockly.Trashcan.prototype.clearWorkspace=function(){this.workspace_.clear()};
...
Blockly.Xml.domToBlock_=function(a,b){var c=b.getAttribute("type");if(!c)throw"Block type unspecified: \n"+b.outerHTML;var d=new Blockly.Block(a,c);d.initSvg();var e=b.getAttribute("inline");e&&d.setInputsInline("true"==e);(e=b.getAttribute("collapsed"))&&d.setCollapsed("true"==e);(e=b.getAttribute("disabled"))&&d.setDisabled("true"==e);(e=b.getAttribute("deletable"))&&d.setDeletable("true"==e);(e=b.getAttribute("movable"))&&d.setMovable("true"==e);(e=b.getAttribute("editable"))&&d.setEditable("true"==
e);for(var f=null,e=0,g;g=b.childNodes[e];e++)if(3!=g.nodeType||!g.data.match(/^\s*$/)){var h,f=null;h=0;for(var k;k=g.childNodes[h];h++)3==k.nodeType&&k.data.match(/^\s*$/)||(f=k);k=g.getAttribute("name");switch(g.nodeName.toLowerCase()){case "mutation":d.domToMutation&&d.domToMutation(g);break;case "comment":d.setCommentText(g.textContent);(f=g.getAttribute("pinned"))&&d.comment.setVisible("true"==f);f=parseInt(g.getAttribute("w"),10);h=parseInt(g.getAttribute("h"),10);isNaN(f)||isNaN(h)||d.comment.setBubbleSize(f,
h);break;case "title":d.setTitleValue(g.textContent,k);break;case "value":case "statement":h=d.getInput(k);if(!h)throw"Input "+k+" does not exist in block "+c;if(f&&"block"==f.nodeName.toLowerCase())if(f=Blockly.Xml.domToBlock_(a,f),f.outputConnection)h.connection.connect(f.outputConnection);else if(f.previousConnection)h.connection.connect(f.previousConnection);else throw"Child block does not have output or previous statement.";break;case "next":if(f&&"block"==f.nodeName.toLowerCase()){if(!d.nextConnection)throw"Next statement does not exist.";
if(d.nextConnection.targetConnection)throw"Next statement is already connected.";f=Blockly.Xml.domToBlock_(a,f);if(!f.previousConnection)throw"Next block does not have previous statement.";d.nextConnection.connect(f.previousConnection)}}d.setContents&&"title"==g.nodeName&&function(){var a=g.textContent;setTimeout(function(){d.setContents(a)},0)}()}(c=d.nextConnection&&d.nextConnection.targetBlock())?c.render():d.render();return d};
Blockly.Xml.deleteNext=function(a){for(var b=0,c;c=a.childNodes[b];b++)if("next"==c.nodeName.toLowerCase()){a.removeChild(c);break}};Blockly.Xml=Blockly.Xml;Blockly.Xml.domToText=Blockly.Xml.domToText;Blockly.Xml.domToWorkspace=Blockly.Xml.domToWorkspace;Blockly.Xml.textToDom=Blockly.Xml.textToDom;Blockly.Xml.workspaceToDom=Blockly.Xml.workspaceToDom;Blockly.StickySpot={};Blockly.StickySpot.height=30;Blockly.StickySpot.update=function(){if(0==Blockly.Block.dragMode_){var a=Blockly.getMainWorkspace().getMetrics().viewWidth/2;Blockly.getMainWorkspace().getTopBlocks().forEach(function(b){if(b.isSticky){var c=Math.ceil(a-b.getHeightWidth().width/2)-15,d=Blockly.StickySpot.height,e=b.getRelativeToSurfaceXY();b.moveBy(c-e.x,d-e.y)}});1==Blockly.getMainWorkspace().getAllBlocks().length&&Blockly.getMainWorkspace().scrollbar.set(0,0)}};Blockly.Workspace=function(a,b){this.getMetrics=a;this.setMetrics=b;this.isFlyout=!1;this.topBlocks_=[];this.maxBlocks=Infinity;Blockly.ConnectionDB.init(this)};Blockly.Workspace.SCAN_ANGLE=3;Blockly.Workspace.prototype.dragMode=!1;Blockly.Workspace.prototype.scrollX=0;Blockly.Workspace.prototype.scrollY=0;Blockly.Workspace.prototype.trashcan=null;Blockly.Workspace.prototype.fireChangeEventPid_=null;Blockly.Workspace.prototype.scrollbar=null;
...
Blockly.Workspace.prototype.fireChangeEvent=function(){this.fireEvent("blocklyWorkspaceChange")};Blockly.Workspace.prototype.fireImmediateChangeEvent=function(){this.fireEvent("immediateBlocklyWorkspaceChange")};Blockly.Workspace.prototype.fireEvent=function(a){this.fireChangeEventPid_&&window.clearTimeout(this.fireChangeEventPid_);var b=this.svgBlockCanvas_;b&&(this.fireChangeEventPid_=window.setTimeout(function(){Blockly.fireUiEvent(b,a)},0))};
...
Blockly.Icon.prototype.iconClick_=function(a){this.block_.isEditable()&&!this.block_.isInFlyout&&this.setVisible(!this.isVisible())};Blockly.Icon.prototype.updateColour=function(){if(this.isVisible()){var a=Blockly.makeColour(this.block_.getColour());this.bubble_.setColour(a)}};
...
Blockly.Connection.prototype.moveTo=function(a,b){this.inDB_&&this.dbList_[this.type].removeConnection_(this);this.x_=a;this.y_=b;this.dbList_[this.type].addConnection_(this)};Blockly.Connection.prototype.moveBy=function(a,b){this.moveTo(this.x_+a,this.y_+b)};Blockly.Connection.highlightedPath_=[];
Blockly.Connection.prototype.highlight=function(){var a=this.sourceBlock_.getRelativeToSurfaceXY(),b=this.x_-a.x,a=this.y_-a.y,c=new Blockly.Builder;c.moveTo(0,0);"VerticalTrapezoid"==this.desiredStrategy?(b=this.connectX,a=this.connectY,c.drawConnectionTrapezoid("vertical","input")):"VerticalTriangle"==this.desiredStrategy?(b=this.connectX,a=this.connectY,c.drawConnectionTriangle("input")):"InlineTrapezoid"==this.desiredStrategy?(b=this.connectX,a=this.connectY,c.drawConnectionInlineTrapezoid()):
"InlineString"==this.desiredStrategy?(b=this.connectX,a=this.connectY,c.drawConnectionInlineString()):"InlineBox"==this.desiredStrategy?(b=this.connectX,a=this.connectY,c.drawConnectionInlineBox()):"DoubleBox"==this.desiredStrategy?(b=this.connectX,a=this.connectY,c.drawConnectionDoubleBox("input")):this.type==Blockly.INPUT_VALUE||this.type==Blockly.OUTPUT_VALUE?(c.moveTo(12,-1*(Blockly.Builder.CONNECTION_DEPTH/2+2)),c.drawVerticalInput()):(c.moveTo(Blockly.Builder.CONNECTION_WIDTH/2*-1,0),c.drawIncomingConnection());
Blockly.Connection.highlightedPath_.push(Blockly.createSvgElement("path",{"class":"blocklyHighlightedConnectionPath",d:c.toString(),transform:"translate("+b+", "+a+")"},this.sourceBlock_.getSvgRoot()))};Blockly.Connection.prototype.unhighlight=function(){for(var a=0;a<Blockly.Connection.highlightedPath_.length;a++)goog.dom.removeNode(Blockly.Connection.highlightedPath_[a]);Blockly.Connection.highlightedPath_=[]};
Blockly.Connection.prototype.tighten_=function(){if("InlineTrapezoid"==this.desiredStrategy||"InlineBox"==this.desiredStrategy||"InlineString"==this.desiredStrategy){var a=this.targetBlock(),b=a.getSvgRoot();if(!b)throw"block is not rendered.";var c=this.connectX,d=this.connectY;a.getSvgRoot().setAttribute("transform","translate("+c+", "+d+")");a.moveConnections_(-c,-d)}else if(c=Math.round(this.targetConnection.x_-this.x_),d=Math.round(this.targetConnection.y_-this.y_),0!=c||0!=d){a=this.targetBlock();
b=a.getSvgRoot();if(!b)throw"block is not rendered.";b=Blockly.getRelativeXY_(b);a.getSvgRoot().setAttribute("transform","translate("+(b.x-c)+", "+(b.y-d)+")");a.moveConnections_(-c,-d)}};
Blockly.Connection.prototype.closest=function(a,b,c){function d(b){var c=e[b];if((c.type==Blockly.OUTPUT_VALUE||c.type==Blockly.PREVIOUS_STATEMENT)&&c.targetConnection||!n.checkType_(c))return!0;c=c.sourceBlock_;do{if(l==c)return!0;c=c.getParent()}while(c);var d=f-e[b].x_,c=g-e[b].y_,d=Math.sqrt(d*d+c*c);d<=a&&(k=e[b],a=d);return c<a}if(this.targetConnection)return{connection:null,radius:a};var e=this.dbList_[Blockly.OPPOSITE_TYPE[this.type]],f=this.x_+b,g=this.y_+c;b=0;for(var h=c=e.length-2;b<h;)e[h].y_<
g?b=h:c=h,h=Math.floor((b+c)/2);c=b=h;var k=null,l=this.sourceBlock_,n=this;if(e.length){for(;0<=b&&d(b);)b--;do c++;while(c<e.length&&d(c))}return{connection:k,radius:a}};Blockly.Connection.prototype.checkType_=function(a){if(Blockly.TYPE_RULES[this.sourceBlock_.type].strategy!=a.desiredStrategy)return!1;if(!this.check_||!a.check_)return!0;for(var b=0;b<this.check_.length;b++)if(-1!=a.check_.indexOf(this.check_[b]))return!0;return!1};
...
Blockly.ContextMenu.show=function(a,b){};Blockly.ContextMenu.optionToDom=function(a){var b=Blockly.createSvgElement("g",{"class":"blocklyMenuDiv"},null);Blockly.createSvgElement("rect",{height:Blockly.ContextMenu.Y_HEIGHT},b);var c=Blockly.createSvgElement("text",{"class":"blocklyMenuText",x:Blockly.ContextMenu.X_PADDING,y:15},b);a=document.createTextNode(a);c.appendChild(a);return b};
Blockly.ContextMenu.hide=function(){Blockly.ContextMenu.visible&&(Blockly.ContextMenu.svgGroup.style.display="none",Blockly.ContextMenu.visible=!1)};Blockly.ContextMenu.callbackFactory=function(a,b){return function(){var c=Blockly.Xml.domToBlock_(a.workspace,b),d=a.getRelativeToSurfaceXY();d.x=Blockly.RTL?d.x-Blockly.SNAP_RADIUS:d.x+Blockly.SNAP_RADIUS;d.y+=2*Blockly.SNAP_RADIUS;c.moveBy(d.x,d.y);c.select()}};Blockly.Field=function(a){this.sourceBlock_=null;this.fieldGroup_=Blockly.createSvgElement("g",{},null);this.borderRect_=Blockly.createSvgElement("rect",{x:-1*Blockly.Builder.HORIZONTAL_FIELD_PADDING,y:-1*(Blockly.Builder.FONT_SIZE+Blockly.Builder.VERTICAL_FIELD_PADDING/2),height:Blockly.Builder.FONT_SIZE+2*Blockly.Builder.VERTICAL_FIELD_PADDING},this.fieldGroup_);this.textElement_=Blockly.createSvgElement("text",{"class":"blocklyText"},this.fieldGroup_);this.size_={height:Blockly.Builder.LINE_HEIGHT,
width:0};this.setText(a);this.visible_=!0};Blockly.Field.prototype.clone=function(){goog.asserts.fail("There should never be an instance of Field, only its derived classes.")};Blockly.Field.NBSP="\u00a0";Blockly.Field.prototype.EDITABLE=!0;
...
Blockly.Field.prototype.setVisible=function(a){this.visible_=a;this.getRootElement().style.display=a?"block":"none"};Blockly.Field.prototype.getRootElement=function(){return this.fieldGroup_};Blockly.Field.prototype.render_=function(){var a=Math.max(this.textElement_.getComputedTextLength()+2*Blockly.Builder.HORIZONTAL_FIELD_PADDING,Blockly.Builder.MINIMUM_FIELD_WIDTH);this.borderRect_&&this.borderRect_.setAttribute("width",a);this.size_.width=a};
...
Blockly.FieldLabel.prototype.setTooltip=function(a){this.textElement_.tooltip=a};Blockly.Input=function(a,b,c,d){this.type=a;this.name=b;this.sourceBlock_=c;this.connection=d;this.titleRow=[];this.align=Blockly.ALIGN_LEFT;this.visible_=!0};
...
Blockly.Input.prototype.setAlign=function(a){this.align=a;this.sourceBlock_.rendered&&this.sourceBlock_.render();return this};Blockly.Input.prototype.setDefaultValue=function(a){this.connection.defaultValue=a;return this};Blockly.Input.prototype.setRange=function(a,b){this.connection.range={min:a,max:b};return this};Blockly.Input.prototype.init=function(){for(var a=0;a<this.titleRow.length;a++)this.titleRow[a].init(this.sourceBlock_)};
...
this.svgDialog_.appendChild(this.workspace_.createDom());return this.svgDialog_};
...
Blockly.Block.prototype.setWarningText=function(a){this.isInFlyout&&(a=null);var b=!1;goog.isString(a)?(this.warning||(this.warning=new Blockly.Warning(this),b=!0),this.warning.setText(a)):this.warning&&(this.warning.dispose(),b=!0);b&&this.rendered&&(this.render(),this.bumpNeighbours_())};Blockly.Block.prototype.render=function(){goog.asserts.assertObject(this.svg_,"Uninitialized block cannot be rendered.  Call block.initSvg()");this.svg_.render()};
Blockly.Block.prototype.asHash=function(){var a=this.toString(),b=this.childBlocks_;b&&b.forEach(function(b,c,d){a+=b.asHash()});for(var c=b=0;c<a.length;c++)var d=a.charCodeAt(c),b=(b<<5)-b+d,b=b&b;return b};WordFilter=function(a,b){this.blacklist=RegExp("(\\b|^)"+a.join("\\b|\\b")+"(\\b|$)");this.whitelist=b};WordFilter.prototype.normalize=function(a){return a.toUpperCase().replace(/[^a-zA-Z0-9#\/ ]/g,"")};WordFilter.prototype.filterThroughWhitelist=function(a){for(var b=0,c;c=this.whitelist[b];b++)a=a.replace(RegExp(c,"g"),"");return a};WordFilter.prototype.containsBlacklistedWords=function(a){return this.blacklist.test(a)};
Blockly.Filter={filter:new WordFilter("4r5e;5h1t;5hit;a55;anal;anus;ar5e;arrse;arse;ass;ass-fucker;asses;assfucker;assfukka;asshole;assholes;asswhole;a_s_s;b\\!tch;b00bs;b17ch;b1tch;ballbag;balls;ballsack;bastard;beastial;beastiality;bellend;bestial;bestiality;bi\\+ch;biatch;bitch;bitcher;bitchers;bitches;bitchin;bitching;bloody;blow job;blowjob;blowjobs;boiolas;bollock;bollok;boner;boob;boobs;booobs;boooobs;booooobs;booooooobs;breasts;buceta;bugger;bum;bunny fucker;butt;butthole;buttmuch;buttplug;c0ck;c0cksucker;carpet muncher;cawk;chink;cipa;cl1t;clit;clitoris;clits;cnut;cock;cock-sucker;cockface;cockhead;cockmunch;cockmuncher;cocks;cocksuck ;cocksucked ;cocksucker;cocksucking;cocksucks ;cocksuka;cocksukka;cok;cokmuncher;coksucka;coon;cox;crap;cum;cummer;cumming;cums;cumshot;cunilingus;cunillingus;cunnilingus;cunt;cuntlick ;cuntlicker ;cuntlicking ;cunts;cyalis;cyberfuc;cyberfuck ;cyberfucked ;cyberfucker;cyberfuckers;cyberfucking ;d1ck;damn;dick;dickhead;dildo;dildos;dink;dinks;dirsa;dlck;dog-fucker;doggin;dogging;donkeyribber;doosh;duche;dyke;ejaculate;ejaculated;ejaculates ;ejaculating ;ejaculatings;ejaculation;ejakulate;f u c k;f u c k e r;f4nny;fag;fagging;faggitt;faggot;faggs;fagot;fagots;fags;fanny;fannyflaps;fannyfucker;fanyy;fatass;fcuk;fcuker;fcuking;feck;fecker;felching;fellate;fellatio;fingerfuck ;fingerfucked ;fingerfucker ;fingerfuckers;fingerfucking ;fingerfucks ;fistfuck;fistfucked ;fistfucker ;fistfuckers ;fistfucking ;fistfuckings ;fistfucks ;flange;fook;fooker;fuck;fucka;fucked;fucker;fuckers;fuckhead;fuckheads;fuckin;fucking;fuckings;fuckingshitmotherfucker;fuckme ;fucks;fuckwhit;fuckwit;fudge packer;fudgepacker;fuk;fuker;fukker;fukkin;fuks;fukwhit;fukwit;fux;fux0r;f_u_c_k;gangbang;gangbanged ;gangbangs ;gaylord;gaysex;goatse;God;god-dam;god-damned;goddamn;goddamned;hardcoresex ;heshe;hoar;hoare;hoer;homo;hore;horniest;horny;hotsex;jack-off ;jackoff;jap;jerk-off ;jism;jiz ;jizm ;jizz;kawk;knob;knobead;knobed;knobend;knobhead;knobjocky;knobjokey;kock;kondum;kondums;kum;kummer;kumming;kums;kunilingus;l3i\\+ch;l3itch;labia;lmfao;lust;lusting;m0f0;m0fo;m45terbate;ma5terb8;ma5terbate;masochist;master-bate;masterb8;masterbat;masterbat3;masterbate;masterbation;masterbations;masturbate;mo-fo;mof0;mofo;mothafuck;mothafucka;mothafuckas;mothafuckaz;mothafucked ;mothafucker;mothafuckers;mothafuckin;mothafucking ;mothafuckings;mothafucks;mother fucker;motherfuck;motherfucked;motherfucker;motherfuckers;motherfuckin;motherfucking;motherfuckings;motherfuckka;motherfucks;muff;mutha;muthafecker;muthafuckker;muther;mutherfucker;n1gga;n1gger;nazi;nigg3r;nigg4h;nigga;niggah;niggas;niggaz;nigger;niggers ;nob;nob jokey;nobhead;nobjocky;nobjokey;numbnuts;nutsack;orgasim ;orgasims ;orgasm;orgasms ;p0rn;pawn;pecker;penis;penisfucker;phonesex;phuck;phuk;phuked;phuking;phukked;phukking;phuks;phuq;pigfucker;pimpis;piss;pissed;pisser;pissers;pisses ;pissflaps;pissin ;pissing;pissoff ;poop;porn;porno;pornography;pornos;prick;pricks ;pron;pube;pusse;pussi;pussies;pussy;pussys ;rectum;retard;rimjaw;rimming;s hit;s\\.o\\.b;sadist;schlong;screwing;scroat;scrote;scrotum;semen;sex;sh\\!t;sh1t;shag;shagger;shaggin;shagging;shemale;shit;shitdick;shite;shited;shitey;shitfuck;shitfull;shithead;shiting;shitings;shits;shitted;shitter;shitters ;shitting;shittings;shitty ;skank;slut;sluts;smegma;smut;snatch;son-of-a-bitch;spac;spunk;s_h_i_t;t1tt1e5;t1tties;teets;teez;testical;testicle;tit;titfuck;tits;titt;tittie5;tittiefucker;titties;tittyfuck;tittywank;titwank;tosser;turd;tw4t;twat;twathead;twatty;twunt;twunter;v14gra;v1gra;vagina;viagra;vulva;w00se;wang;wank;wanker;wanky;whoar;whore;willies;willy;xrated;xxx;hates;sucks;hate;suck".split(";"),"ambassadors;assassinate;assemblages;assemblyman;assemblymen;assentation;assertively;assessments;asseverated;asseverates;assiduities;assiduously;assignation;assignments;assimilable;assimilated;assimilates;assimilator;assistances;associating;association;associative;assoilments;assortative;assortments;assuagement;assumptions;assuredness;bassoonists;beargrasses;bentgrasses;bioassaying;bluegrasses;carnassials;cassiterite;cassidy;sasha;cassowaries;classically;classicisms;classicists;classicized;classicizes;classifiers;classifying;coassisting;compassable;compassions;cordgrasses;crabgrasses;crassitudes;crassnesses;cuirassiers;detasseling;detasselled;disassemble;disassembly;dispassions;embarrassed;embarrasses;encompassed;encompasses;gallowglass;gassinesses;glassblower;glasshouses;glassmakers;glassmaking;glasspapers;glassworker;grasshopper;gyrocompass;harassments;hourglasses;immunoassay;impassioned;impassively;impassivity;isinglasses;knotgrasses;massasaugas;massinesses;massiveness;misassaying;misassemble;misassigned;misbiassing;misclassify;misclassing;outclassing;overasserts;overclasses;overpassing;passacaglia;passageways;passagework;passionless;passivating;passivation;passiveness;passivities;peppergrass;postclassic;preassigned;preassuring;reassailing;reassembled;reassembles;reasserting;reassertion;reassessing;reassigning;reassorting;reassurance;sandglasses;sassafrases;sassinesses;semiclassic;subassembly;subclassify;subclassing;surpassable;switchgrass;tallgrasses;teargassing;thalassemia;thalassemic;trespassers;trespassing;turfgrasses;unassembled;unassertive;unclassical;underpasses;unsurpassed;windlassing;wineglasses;wiregrasses;amassments;ambassador;assagaiing;assailable;assailants;assaulters;assaulting;assaultive;assegaiing;assemblage;assemblers;assemblies;assembling;assertedly;assertions;assessable;assessment;asseverate;assignable;assignment;assimilate;assistance;assistants;associated;associates;assoilment;assonances;assonantal;assortment;assumpsits;assumption;assumptive;assurances;bassetting;bassnesses;bassoonist;bioassayed;brassbound;brasseries;brassieres;brassiness;brasswares;bromegrass;bunchgrass;canvassers;canvassing;carnassial;cassations;casseroles;cassimeres;cassingles;cassoulets;chassepots;classicals;classicism;classicist;classicize;classified;classifier;classifies;classiness;classmates;classrooms;classworks;coassisted;coassuming;compassing;compassion;contrabass;crassitude;crevassing;cuirassier;cuirassing;cutgrasses;declassify;declassing;demitasses;detasseled;dispassion;eelgrasses;embassages;eyeglasses;fiberglass;fibreglass;forepassed;fricasseed;fricassees;galleasses;galliasses;glasshouse;glassiness;glassmaker;glasspaper;glasswares;glassworks;glassworms;glassworts;goosegrass;grasslands;grassplots;grassroots;groundmass;harassment;impassable;impassably;impassible;impassibly;impassions;interclass;landmasses;lassitudes;lemongrass;madrassahs;massacrers;massacring;massasauga;masseteric;matelasses;mattrasses;misassayed;misassigns;misbiassed;misbiasses;misclassed;misclasses;molasseses;neoclassic;nonclasses;nonpassive;nutgrasses;outclassed;outclasses;outgassing;outpassing;overassert;overpassed;overpasses;paillasses;palliasses;passageway;passalongs;passengers;passepieds;passerines;passionals;passionate;passivated;passivates;passivisms;passivists;pingrasses;plateglass;potassiums;preassigns;preassured;preassures;raygrasses;reassailed;reassemble;reassembly;reasserted;reassessed;reassesses;reassigned;reassorted;reassuming;reassuring;reclassify;repassages;ribgrasses;ryegrasses;sargassums;sassywoods;smartasses;spyglasses;subclassed;subclasses;subvassals;sunglasses;superclass;surpassers;surpassing;tasselling;teargassed;teargasses;trespassed;trespasser;trespasses;unassailed;unassigned;unassisted;unassuaged;unassuming;underclass;unpassable;vassalages;wassailers;wassailing;windlassed;windlasses;witchgrass;amassable;amassment;assagaied;assailant;assailers;assailing;assassins;assaulted;assaulter;assayable;assegaied;assembled;assembler;assembles;assenters;assenting;assentive;assentors;asserters;asserting;assertion;assertive;assertors;assessing;assessors;assetless;assiduity;assiduous;assignats;assignees;assigners;assigning;assignors;assistant;assisters;assisting;assistive;assistors;associate;assoiling;assonance;assonants;assorters;assorting;assuagers;assuaging;assuasive;assumable;assumably;assumedly;assumpsit;assurable;assurance;assuredly;assurgent;asswaging;baasskaps;basseting;bassetted;bassinets;basswoods;beargrass;bentgrass;biassedly;bioassays;biogasses;biomasses;bluegrass;brassages;brassards;brassarts;brasserie;brassicas;brassiere;brassiest;brassware;bypassing;canvassed;canvasser;canvasses;carassows;carcasses;cassation;casserole;cassettes;cassimere;cassingle;cassoulet;cassowary;chasseing;chassepot;chasseurs;classable;classical;classiest;classisms;classists;classless;classmate;classroom;classwork;coassists;coassumed;coassumes;compassed;compasses;cordgrass;crabgrass;crassness;crevassed;crevasses;cuirassed;cuirasses;curassows;cutlasses;declassed;declasses;degassers;degassing;demitasse;detassels;embarrass;embassage;embassies;encompass;fricassee;gassiness;glassfuls;glassiest;glassines;glassless;glassware;glasswork;glassworm;grassiest;grassland;grassless;grasslike;grassplot;grassroot;harassers;harassing;hardasses;hourglass;impassion;impassive;isinglass;knotgrass;kolbassis;lassitude;madrassah;madrassas;massacred;massacrer;massacres;massagers;massaging;masscults;masseters;masseuses;massicots;massiness;massively;matelasse;matrasses;misassays;misassign;outpassed;outpasses;overclass;paillasse;palliasse;passadoes;passaging;passalong;passbands;passbooks;passenger;passepied;passerine;passersby;passingly;passional;passivate;passively;passivism;passivist;passivity;passovers;passports;passwords;piassabas;piassavas;potassium;preassign;preassure;reassails;reasserts;reassigns;reassorts;reassumed;reassumes;reassured;reassures;repassage;repassing;sandglass;sargassos;sargassum;sassabies;sassafras;sassiness;sasswoods;sassywood;subbasses;subvassal;surpassed;surpasser;surpasses;syngasses;tallgrass;tasseling;tasselled;thalassic;turfgrass;unamassed;unassayed;unassured;unbiassed;underpass;vassalage;vavassors;wassailed;wassailer;wineglass;wiregrass;wiseasses;wrassling;zebrasses;admasses;amassers;amassing;assagais;assailed;assailer;assassin;assaults;assayers;assaying;assegais;assemble;assembly;assented;assenter;assentor;asserted;asserter;assertor;assessed;assesses;assessor;assignat;assigned;assignee;assigner;assignor;assisted;assister;assistor;assoiled;assonant;assorted;assorter;assuaged;assuager;assuages;assumers;assuming;assureds;assurers;assuring;assurors;asswaged;asswages;avgasses;baasskap;babassus;bagasses;basseted;bassetts;bassinet;bassists;bassness;bassoons;basswood;biassing;bioassay;brassage;brassard;brassart;brassica;brassier;brassies;brassily;brassing;brassish;bypassed;bypasses;camasses;carassow;cassabas;cassatas;cassavas;cassenas;cassenes;cassette;cassinas;cassines;cassinos;cassises;cassocks;chasseur;classers;classico;classics;classier;classify;classily;classing;classism;classist;classons;coassist;coassume;crassest;crevasse;curassow;cutgrass;declasse;degassed;degasser;degasses;detassel;eelgrass;eyeglass;galleass;galliass;gassiest;gassings;glassful;glassier;glassies;glassily;glassine;glassing;glassman;glassmen;grassier;grassily;grassing;harassed;harasser;harasses;hassiums;hassling;hassocks;impasses;jurassic;kavasses;kolbassi;landmass;lassoers;lassoing;madrassa;massacre;massaged;massager;massages;masscult;massedly;masseter;masseurs;masseuse;massicot;massiest;massless;mattrass;megasses;misassay;misclass;molasses;morasses;nonclass;nutgrass;oquassas;outclass;overpass;passable;passably;passades;passados;passaged;passages;passband;passbook;passerby;passible;passings;passions;passives;passkeys;passless;passover;passport;passuses;password;piassaba;piassava;pingrass;potassic;quassias;quassins;rassling;raygrass;reassail;reassert;reassess;reassign;reassort;reassume;reassure;repassed;repasses;ribgrass;rubasses;ryegrass;sargasso;sassiest;sasswood;smartass;spyglass;strasses;subclass;sunglass;tasseled;trespass;triassic;unclassy;vavassor;vinasses;wassails;windlass;wrassled;wrassles;amassed;amasser;amasses;assagai;assails;assault;assayed;assayer;assegai;assents;asserts;assigns;assists;assizes;asslike;assoils;assorts;assuage;assumed;assumer;assumes;assured;assurer;assures;assuror;asswage;babassu;bagasse;bassets;bassett;bassist;bassoon;biassed;biasses;biomass;brassed;brasses;brassie;canvass;carcass;cassaba;cassata;cassava;cassena;cassene;cassias;cassina;cassine;cassino;cassock;chassed;chasses;chassis;classed;classer;classes;classic;classis;classon;compass;crasser;crassly;cuirass;dassies;declass;embassy;eyasses;frasses;gassers;gassier;gassily;gassing;glassed;glasses;glassie;grassed;grasses;hardass;hassels;hassium;hassled;hassles;hassock;impasse;kvasses;lassies;lassoed;lassoer;lassoes;massage;masseur;massier;massifs;massing;massive;matrass;megasse;morassy;oquassa;outpass;passade;passado;passage;passant;passels;passers;passing;passion;passive;passkey;quasses;quassia;quassin;rassled;rassles;rubasse;sassaby;sassier;sassies;sassily;sassing;subbass;surpass;tassels;tassets;tassies;trasses;vassals;vinasse;wassail;wrassle;zebrass;admass;assail;assais;assays;assent;assert;assess;assets;assign;assist;assize;assoil;assort;assume;assure;badass;bagass;basses;basset;bassly;bassos;brassy;bypass;camass;cassia;cassis;chasse;classy;dassie;gassed;gasser;gasses;glassy;grassy;harass;hassel;hassle;jassid;kavass;lasses;lassie;lassis;lassos;massas;massed;masses;massif;megass;morass;passed;passee;passel;passer;passes;passim;passus;rassle;repass;sassed;sasses;strass;tassel;tasses;tasset;tassie;vassal;wrasse;amass;assai;assay;asses;asset;bassi;basso;bassy;brass;class;crass;eyass;frass;gassy;glass;grass;kvass;lassi;lasso;massa;masse;massy;passe;quass;sassy;tasse;trass;bass;lass;mass;pass;sass;tass;accumulated;accumulates;accumulator;acuminating;altocumulus;circumfused;circumfuses;circumlunar;circumpolar;circumspect;circumvents;cirrocumuli;cumberbunds;cummerbunds;cumulations;cumulonimbi;disencumber;documentary;documenters;documenting;ecumenicism;ecumenicist;ecumenicity;encumbering;encumbrance;incumbering;oecumenical;accumulate;acuminated;acuminates;altocumuli;cacuminals;circumflex;circumfuse;circumvent;colchicums;cumberbund;cumbersome;cumbrances;cumbrously;cummerbund;cumulating;cumulation;cumulative;cumuliform;dicumarols;documental;documented;documenter;doronicums;ecumenical;ecumenisms;ecumenists;encumbered;incumbency;incumbents;incumbered;practicums;procumbent;recumbency;succumbing;accumbent;acuminate;acuminous;cacuminal;capsicums;colchicum;cucumbers;cumberers;cumbering;cumbrance;cumulated;cumulates;decumbent;dicumarol;documents;doronicum;ecumenics;ecumenism;ecumenist;encumbers;guaiacums;guaiocums;incumbent;incumbers;molluscum;practicum;recumbent;scumbling;scummiest;succumbed;triticums;viaticums;capsicum;cucumber;cumarins;cumbered;cumberer;cumbrous;cumquats;cumshaws;cumulate;cumulous;curcumas;document;ecumenic;encumber;guaiacum;guaiocum;incumber;macumbas;modicums;panicums;scumbags;scumbled;scumbles;scumless;scumlike;scummers;scummier;scummily;scumming;succumbs;triticum;viaticum;acumens;curcuma;decuman;macumba;modicum;panicum;succumb;talcums;acumen;caecum;cumber;cumbia;cumins;cummer;cummin;cumuli;locums;talcum;basketballs;butterballs;tetherballs;volleyballs;beachballs;dodgeballs;eightballs;speedballs;ballsiest;baseballs;cornballs;fastballs;fireballs;foosballs;footballs;forkballs;goofballs;hairballs;handballs;hardballs;heelballs;highballs;kickballs;meatballs;mothballs;snowballs;softballs;eyeballs;gumballs;lowballs;oddballs;pinballs;bumblebee ;butterballs;butterflied;butterflies;butterflyer;butterball;butterburs;buttercups;butterfats;butterfish;butteriest;butterless;buttermilk;butternuts;butterweed;butterwort;buttinskis;buttonball;buttonbush;buttonhook;buttonless;buttonwood;buttressed;buttresses;buttstocks;keybuttons;misbuttons;rebuttable;rebuttoned;unbuttered;unbuttoned;butterbur;buttercup;butterfly;butterier;butteries;buttering;butternut;buttinski;buttinsky;buttoners;buttoning;buttstock;keybutton;misbutton;rebuttals;rebutters;rebutting;rebuttons;unbuttons;buttoned;buttoner;buttress;rebuttal;rebutted;rebutter;rebutton;unbutton;buttons".split(";"))};
Blockly.Filter.stripUnrecognized=function(a){return this.filter.normalize(a)};Blockly.Filter.isAllowed=function(a){var b=Blockly.Filter.filter,c=["Filtering "+a];a=b.normalize(a).toLowerCase();c.push("After adjustment: "+a);a=b.filterThroughWhitelist(a);c.push("After filtering whitelisted words: "+a);log(c.join("\n"));return b.containsBlacklistedWords(a)?(log("The message "+a+" has a naughty word in it."),EventBridge.Filtering.failed(),!1):!0};Blockly.FieldTextInput=function(a,b){Blockly.FieldTextInput.superClass_.constructor.call(this,a);this.changeHandler_=b};goog.inherits(Blockly.FieldTextInput,Blockly.Field);Blockly.FieldTextInput.prototype.clone=function(){return new Blockly.FieldTextInput(this.getText(),this.changeHandler_)};Blockly.FieldTextInput.prototype.CURSOR="text";Blockly.FieldTextInput.prototype.dispose=function(){Blockly.WidgetDiv.hideIfField(this);Blockly.FieldTextInput.superClass_.dispose.call(this)};
Blockly.FieldTextInput.prototype.setText=function(a){if(null!==a){a=Blockly.Filter.stripUnrecognized(a);if(this.changeHandler_){var b=this.changeHandler_(a);null!==b&&void 0!==b&&(a=b)}Blockly.Field.prototype.setText.call(this,a);Blockly.getMainWorkspace().fireChangeEvent()}};
Blockly.FieldTextInput.prototype.showEditor_=function(){setTimeout(function(){Blockly.getMainWorkspace().fireImmediateChangeEvent()},0);if(goog.userAgent.MOBILE){var a=window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE,this.text_);if(this.changeHandler_){var b=this.changeHandler_(a);void 0!==b&&(a=b)}null!==a&&(this.setText(a),this.validateValue_(a))}else Blockly.WidgetDiv.show(this,this.dispose_),b=Blockly.WidgetDiv.DIV,a=goog.dom.createDom("input","blocklyHtmlInput"),a.setAttribute("maxlength","25"),
Blockly.FieldTextInput.htmlInput_&&Blockly.unbindEvent_(Blockly.FieldTextInput.htmlInput_.onWorkspaceChangeWrapper_),Blockly.FieldTextInput.htmlInput_=a,b.appendChild(a),a.value=a.defaultValue=this.text_,a.oldValue_=null,this.validate_(),this.resizeEditor_(),a.focus(),a.select(),a.onKeyUpWrapper_=Blockly.bindEvent_(a,"keyup",this,this.onHtmlInputChange_),a.onKeyPressWrapper_=Blockly.bindEvent_(a,"keypress",this,this.onHtmlInputChange_),b=this.sourceBlock_.workspace.getCanvas(),a.onWorkspaceChangeWrapper_=
Blockly.bindEvent_(b,"blocklyWorkspaceChange",this,this.resizeEditor_)};Blockly.FieldTextInput.prototype.onHtmlInputChange_=function(a){var b=Blockly.FieldTextInput.htmlInput_;13==a.keyCode?Blockly.WidgetDiv.hide():27==a.keyCode?(this.setText(b.defaultValue),Blockly.WidgetDiv.hide()):(a=b.value,a=a.slice(0,parseInt(b.getAttribute("maxlength"))),a!==b.oldValue_?(b.oldValue_=a,this.setText(a),this.validate_()):goog.userAgent.WEBKIT&&this.sourceBlock_.render(),b.value=Blockly.Filter.stripUnrecognized(a))};
Blockly.FieldTextInput.prototype.validate_=function(){var a=!0;goog.asserts.assertObject(Blockly.FieldTextInput.htmlInput_);var b=Blockly.FieldTextInput.htmlInput_;this.changeHandler_&&(a=this.changeHandler_(b.value));a&&(Blockly.Filter.isAllowed(b.value)||(a=null));null===a?(this.setText(""),Blockly.addClass_(b,"blocklyInvalidInput")):Blockly.removeClass_(b,"blocklyInvalidInput")};
Blockly.FieldTextInput.prototype.validateValue_=function(a){var b=!0;this.changeHandler_&&(b=this.changeHandler_(a));b&&!Blockly.Filter.isAllowed(a)&&(b=!1);b||this.setText("")};
Blockly.FieldTextInput.prototype.resizeEditor_=function(){var a=Blockly.WidgetDiv.DIV;if(this.fieldGroup_){var b=this.fieldGroup_.getBBox();a.style.width=b.width+"px";b=Blockly.getAbsoluteXY_(this.borderRect_);if(Blockly.RTL){var c=this.borderRect_.getBBox();b.x+=c.width;b.x-=a.offsetWidth}b.y+=1;goog.userAgent.WEBKIT&&(b.y-=3);a.style.left=b.x+"px";a.style.top=b.y+"px"}};
...
", "+Blockly.FieldAngle.HALF+" h "+Blockly.FieldAngle.RADIUS+" A "+Blockly.FieldAngle.RADIUS+","+Blockly.FieldAngle.RADIUS+" 0 "+(a>Math.PI?1:0)+" 0 "+b+","+c+" z");this.line_.setAttribute("x2",b);this.line_.setAttribute("y2",c)}}};Blockly.FieldAngle.angleValidator=function(a){a=Blockly.FieldTextInput.numberValidator(a);null!==a&&(a%=360,0>a&&(a+=360),a=String(a));return a};Blockly.FieldCheckbox=function(a,b){Blockly.FieldCheckbox.superClass_.constructor.call(this,"");this.changeHandler_=b;this.checkElement_=Blockly.createSvgElement("rect",{height:"20px",width:"20px"},this.fieldGroup_);this.checkElement_.setAttribute("class","blocklyCheckIsChecked");var c=document.createElementNS("http://www.w3.org/2000/svg","rect");this.checkElement_.parentNode.insertBefore(c,this.checkElement);c.setAttribute("width",20);c.setAttribute("height",20);c.setAttribute("fill","#dedede");
this.bg_=c;this.setValue(a)};goog.inherits(Blockly.FieldCheckbox,Blockly.Field);Blockly.FieldCheckbox.prototype.clone=function(){return new Blockly.FieldCheckbox(this.getValue(),this.changeHandler_)};Blockly.FieldCheckbox.prototype.CURSOR="default";Blockly.FieldCheckbox.prototype.getValue=function(){return String(this.state_).toUpperCase()};
Blockly.FieldCheckbox.prototype.setValue=function(a){a="TRUE"==a;this.state_!==a&&(this.state_=a,this.checkElement_.style.display=a?"block":"none",this.bg_.style.display=a?"none":"block",this.sourceBlock_&&this.sourceBlock_.rendered&&this.sourceBlock_.workspace.fireChangeEvent())};Blockly.FieldCheckbox.prototype.showEditor_=function(){var a=!this.state_;if(this.changeHandler_){var b=this.changeHandler_(a);void 0!==b&&(a=b)}null!==a&&this.setValue(String(a).toUpperCase())};goog.color={};
...
goog.math.isInt=function(a){return isFinite(a)&&0==a%1};goog.math.isFiniteNumber=function(a){return isFinite(a)&&!isNaN(a)};goog.math.safeFloor=function(a,b){goog.asserts.assert(!goog.isDef(b)||0<b);return Math.floor(a+(b||2E-15))};goog.math.safeCeil=function(a,b){goog.asserts.assert(!goog.isDef(b)||0<b);return Math.ceil(a-(b||2E-15))};goog.color.parse=function(a){var b={};a=String(a);var c=goog.color.prependHashIfNecessaryHelper(a);if(goog.color.isValidHexColor_(c))return b.hex=goog.color.normalizeHex(c),b.type="hex",b;c=goog.color.isValidRgbColor_(a);if(c.length)return b.hex=goog.color.rgbArrayToHex(c),b.type="rgb",b;if(goog.color.names&&(c=goog.color.names[a.toLowerCase()]))return b.hex=c,b.type="named",b;throw Error(a+" is not a valid color string");};
...
goog.style.getCssTranslation=function(a){var b;goog.userAgent.IE?b="-ms-transform":goog.userAgent.WEBKIT?b="-webkit-transform":goog.userAgent.OPERA?b="-o-transform":goog.userAgent.GECKO&&(b="-moz-transform");var c;b&&(c=goog.style.getStyle_(a,b));c||(c=goog.style.getStyle_(a,"transform"));return c?(a=c.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};goog.events.KeyCodes={WIN_KEY_FF_LINUX:0,MAC_ENTER:3,BACKSPACE:8,TAB:9,NUM_CENTER:12,ENTER:13,SHIFT:16,CTRL:17,ALT:18,PAUSE:19,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,PRINT_SCREEN:44,INSERT:45,DELETE:46,ZERO:48,ONE:49,TWO:50,THREE:51,FOUR:52,FIVE:53,SIX:54,SEVEN:55,EIGHT:56,NINE:57,FF_SEMICOLON:59,FF_EQUALS:61,FF_DASH:173,QUESTION_MARK:63,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,
...
h||k.push(f);var l=a.getExtraClassNames();l&&k.push.apply(k,l);if(goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("7")){var n=this.getAppliedCombinedClassNames_(k);0<n.length&&(k.push.apply(k,n),c=!0)}g&&h&&!l&&!c||goog.dom.classes.set(b,k.join(" "));this.setAriaStates(a,b);return b};goog.ui.ControlRenderer.prototype.initializeDom=function(a){a.isRightToLeft()&&this.setRightToLeft(a.getElement(),!0);a.isEnabled()&&this.setFocusable(a,a.isVisible())};
...
goog.ui.Control.prototype.handleMouseDown=function(a){this.isEnabled()&&(this.isAutoState(goog.ui.Component.State.HOVER)&&this.setHighlighted(!0),a.isMouseActionButton()||"touchstart"==a.type)&&(this.isAutoState(goog.ui.Component.State.ACTIVE)&&this.setActive(!0),this.renderer_.isFocusable(this)&&this.getKeyEventTarget().focus());!this.isAllowTextSelection()&&a.isMouseActionButton()&&a.preventDefault()};
...
Blockly.FieldColour.prototype.showEditor_=function(){Blockly.FieldTextInput.htmlInput_&&Blockly.unbindEvent_(Blockly.FieldTextInput.htmlInput_.onWorkspaceChangeWrapper_);Blockly.WidgetDiv.show(this,Blockly.FieldColour.dispose_);var a=Blockly.WidgetDiv.DIV,b=new goog.ui.ColorPicker;b.setSize(Blockly.FieldColour.COLUMNS);b.setColors(Blockly.FieldColour.COLOURS);b.render(a);b.setSelectedColor(this.getValue());var c=Blockly.getAbsoluteXY_(this.borderRect_),d=this.borderRect_.getBBox();Blockly.RTL&&(c.x-=
d.width);Blockly.RTL&&(c.x+=a.offsetWidth);1===Blockly.FieldColour.COLUMNS?(c.x-=2,c.y-=d.height+50):(c.y-=97,c.x-=parseInt(23*Blockly.FieldColour.COLUMNS));c.y-=parseInt(Blockly.FieldColour.COLOURS.length/Blockly.FieldColour.COLUMNS*12.5);1===Blockly.FieldColour.COLUMNS&&(c.y+=0);a.style.left=c.x+"px";a.style.top=c.y+"px";var e=this;Blockly.FieldColour.changeEventKey_=goog.events.listen(b,goog.ui.ColorPicker.EventType.CHANGE,function(a){a=a.target.getSelectedColor()||"#000000";Blockly.WidgetDiv.hide();
if(e.changeHandler_){var b=e.changeHandler_(a);void 0!==b&&(a=b)}null!==a&&e.setValue(a)})};Blockly.FieldColour.dispose_=function(){Blockly.FieldColour.changeEventKey_&&goog.events.unlistenByKey(Blockly.FieldColour.changeEventKey_)};Blockly.FieldDropdown=function(a,b,c){this.menuGenerator_=a;this.changeHandler_=b;this.temporaryChangeHandler_=c;this.trimOptions_();a=this.getOptions_()[0];this.value_=a[1];this.arrow_=Blockly.createSvgElement("tspan",{},null);this.arrow_.appendChild(document.createTextNode(Blockly.RTL?"\u25be ":" \u25be"));Blockly.FieldDropdown.superClass_.constructor.call(this,a[0])};goog.inherits(Blockly.FieldDropdown,Blockly.Field);Blockly.FieldDropdown.EVEN_ROW_COLOR="#fcdddd";
Blockly.FieldDropdown.ODD_ROW_COLOR="#f8acaa";Blockly.FieldDropdown.prototype.clone=function(){return new Blockly.FieldDropdown(this.menuGenerator_,this.changeHandler_)};Blockly.FieldDropdown.createDom=function(){var a=Blockly.createSvgElement("g",{"class":"blocklyHidden blocklyFieldDropdown"},null);Blockly.FieldDropdown.svgGroup_=a;Blockly.FieldDropdown.svgOptions_=Blockly.createSvgElement("g",{"class":"blocklyDropdownMenuOptions"},a);return a};
...
Blockly.FieldDropdown.prototype.showEditor_=function(){function a(a){return function(b){this.temporaryChangeHandlerRegistration&&(Blockly.unbindEvent_(this.temporaryChangeHandlerRegistration),delete this.temporaryChangeHandlerRegistration);if(this.changeHandler_){var c=this.changeHandler_(a);void 0!==c&&(a=c)}null!==a&&this.setValue(a);b.stopPropagation()}}function b(a){return function(b){this.setValue(a);this.temporaryChangeHandler_&&this.temporaryChangeHandler_(a);b.stopPropagation()}}var c=Blockly.FieldDropdown.svgGroup_,
d=Blockly.FieldDropdown.svgOptions_;goog.dom.removeChildren(d);Blockly.removeClass_(c,"blocklyHidden");Blockly.FieldDropdown.openDropdown_=this;for(var e=0,f=[],g=null,h=this.getOptions_(),k=0;k<h.length;k++){var l=h[k][1],n=Blockly.ContextMenu.optionToDom(h[k][0]),m=n.firstChild,q=n.lastChild;d.appendChild(n);g||l!=this.value_||(g=Blockly.createSvgElement("text",{"class":"blocklyMenuText",y:15},null),n.insertBefore(g,q),g.appendChild(document.createTextNode("\u2713")));n.setAttribute("transform",
"translate(0, "+k*Blockly.ContextMenu.Y_HEIGHT+")");m.setAttribute("fill",Blockly.FieldDropdown.EVEN_ROW_COLOR);f.push(m);Blockly.bindEvent_(n,"mousedown",null,Blockly.noEvent);this.temporaryChangeHandlerRegistration=Blockly.bindEvent_(n,"mouseover",this,b(l));Blockly.bindEvent_(n,"mouseup",this,a(l));Blockly.bindEvent_(n,"mouseup",null,Blockly.FieldDropdown.hide);e=Math.max(e,q.getComputedTextLength())}e+=2*Blockly.ContextMenu.X_PADDING;e=Math.max(e,this.borderRect_.getBBox().width);for(k=0;k<f.length;k++)f[k].setAttribute("width",
e);if(Blockly.RTL)for(k=0;n=d.childNodes[k];k++)q=n.lastChild,q.setAttribute("text-anchor","end"),q.setAttribute("x",e-Blockly.ContextMenu.X_PADDING);g&&(Blockly.RTL?(g.setAttribute("text-anchor","end"),g.setAttribute("x",e-5)):g.setAttribute("x",5));d=Blockly.getSvgXY_(this.borderRect_);e=this.borderRect_.getBBox();c.setAttribute("transform","translate("+d.x+", "+(d.y+e.height)+")")};
...
Blockly.FieldDropdown.prototype.render_=function(){var a=Math.max(this.textElement_.getComputedTextLength()+2*Blockly.Builder.HORIZONTAL_FIELD_PADDING,Blockly.Builder.DROPDOWN_WIDTH);this.borderRect_&&this.borderRect_.setAttribute("width",a);this.size_.width=a};Blockly.FieldImage=function(a,b,c){this.sourceBlock_=null;this.height_=Number(c);this.width_=Number(b);this.size_={height:this.height_+10,width:this.width_};this.fieldGroup_=Blockly.createSvgElement("g",{},null);this.imageElement_=Blockly.createSvgElement("image",{height:this.height_+"px",width:this.width_+"px"},this.fieldGroup_);this.setText(a);goog.userAgent.GECKO&&(this.rectElement_=Blockly.createSvgElement("rect",{height:this.height_+"px",width:this.width_+"px","fill-opacity":0},this.fieldGroup_))};
goog.inherits(Blockly.FieldImage,Blockly.Field);Blockly.FieldImage.prototype.clone=function(){return new Blockly.FieldImage(this.getText(),this.width_,this.height_)};Blockly.FieldImage.prototype.rectElement_=null;Blockly.FieldImage.prototype.EDITABLE=!1;
...
Blockly.Flyout.onMouseMoveWrapper_=Blockly.bindEvent_(document,"mousemove",this,b.onMouseMove_));c.stopPropagation()}};Blockly.Flyout.prototype.onMouseMove_=function(a){if("mousemove"==a.type&&1>=a.clientX&&0==a.clientY&&0==a.button)a.stopPropagation();else{Blockly.removeAllRanges();var b=a.clientY-Blockly.Flyout.startDragMouseY_;Math.sqrt(Math.pow(a.clientX-Blockly.Flyout.startDragMouseX_,2)+Math.pow(b,2))>Blockly.DRAG_RADIUS&&Blockly.Flyout.startFlyout_.createBlockFunc_(Blockly.Flyout.startBlock_)(a)}};
...
Blockly.Generator.prototype.workspaceToCode=function(a){var b=[];this.init();for(var c=Blockly.mainWorkspace.getTopBlocks(!0),d=0,e;e=c[d];d++)if(!a||a&&a===e.type){var f=this.blockToCode(e);f instanceof Array&&(f=f[0]);f&&(e.outputConnection&&this.scrubNakedValue&&(f=this.scrubNakedValue(f)),b.push(f))}b=b.join("\n");b=this.finish(b);b=b.replace(/^\s+\n/,"");b=b.replace(/\n\s+$/,"\n");return b=b.replace(/[ \t]+\n/g,"\n")};
...
Blockly.Css.CONTENT=["input[type=number]::-webkit-outer-spin-button,","input[type=number]::-webkit-inner-spin-button {","  -webkit-apperance: none !important;","  display: none;","}","input[type=number] {","  width: 94%;","  -moz-appearance:textfield;","}",".blocklyBlockTitle {","  fill: #fff;","  font-family: 'Open Sans', sans-serif;","  font-size: 14px;","  font-weight: 300;","  letter-spacing: 2px;","  text-transform: uppercase;","}",".blocklyBlockSubtitle {","  fill: #fff;","  font-family: 'Open Sans', sans-serif;",
"  font-size: 11px;","  font-weight: normal;","  kerning: 1px;","  text-transform: uppercase;","}",".blocklyBlockLabel {","  fill: #bcbcbc;","  font-family: 'Open Sans', sans-serif;","  font-size: 13px;","  font-weight: normal;","  letter-spacing: 1px;","  text-transform: uppercase;","}",".blocklyBlockLabelSmall {","  fill: #eeecf1;","  font-family: 'Open Sans', sans-serif;","  font-size: 8px;","  font-weight: normal;","  kerning: 1px;","  text-transform: uppercase;","}",".blocklyWidgetDiv {","  position: absolute;",
"  display: none;","  z-index: 999;","}",".blocklyWidgetDiv .with-arrows {","  height: 25px;","  width: 65px;","}",".with-arrows>input[type=number] {","  margin-right: 15px;","  top: 1px;","  width: 25px;","  -moz-appearance:textfield;","}",".with-arrows>.up, .with-arrows>.down {","  background-size: 15px 8px !important;","  float: right;","  height: 10px;","  outline: 0;","  width: 15px;","}",".with-arrows>.up {","  border: none;","  background: url(<<<PATH>>>/media/arrowup.png) no-repeat;","  cursor: pointer;",
"}",".with-arrows>.down {","  border: none;","  background: url(<<<PATH>>>/media/arrowdown.png) no-repeat;","  cursor: pointer;","  margin-top: -7px;","}",".blocklyDraggable {","  /* Hotspot coordinates are baked into the CUR file, but they are still","     required in the CSS due to a Chrome bug.","     http://code.google.com/p/chromium/issues/detail?id=1446 */","  cursor: url(<<<PATH>>>/media/handopen.cur), auto;","  cursor: url(<<<PATH>>>/media/handopen.cur) 8 5, auto;","}",".blocklyDraggable.closed {",
"  /* Hotspot coordinates are baked into the CUR file, but they are still","     required in the CSS due to a Chrome bug.","     http://code.google.com/p/chromium/issues/detail?id=1446 */","  cursor: url(<<<PATH>>>/media/handclosed.cur), auto;","  cursor: url(<<<PATH>>>/media/handclosed.cur) 8 5, auto;","}",".blocklySvg.closed {","  /* Hotspot coordinates are baked into the CUR file, but they are still","     required in the CSS due to a Chrome bug.","     http://code.google.com/p/chromium/issues/detail?id=1446 */",
"  cursor: url(<<<PATH>>>/media/handclosed.cur), auto;","  cursor: url(<<<PATH>>>/media/handclosed.cur) 8 5, auto;","}",".blocklyResizeSE {","  fill: #aaa;","  cursor: se-resize;","}",".blocklyResizeSW {","  fill: #aaa;","  cursor: sw-resize;","}",".blocklyResizeLine {","  stroke-width: 1;","  stroke: #888;","}",".blocklyHighlightedConnectionPath {","  stroke-width: 4px;","  stroke: #fc3;","  fill: none;","}",".blocklyPathLight {","  fill: none;","  stroke-width: 2;","  stroke-linecap: round;","}",
".blocklySelected>.blocklyPath {","  stroke-width: 3px;","  stroke: #fc3;","}",".blocklySelected>.blocklyPathLight {","  display: none;","}",".blocklyDragging>.blocklyPath,",".blocklyDragging>.blocklyPathLight {","  fill-opacity: 0.8;","  stroke-opacity: 0.8;","}",".blocklyDragging>.blocklyPathDark {","  display: none;","}",".blocklyDisabled>.blocklyPath {","  fill-opacity: 0.50;","  stroke-opacity: 0.50;","}",".blocklyDisabled>.blocklyPathLight,",".blocklyDisabled>.blocklyPathDark {","  display: none;",
"}",".blocklyText {","  cursor: default;","  fill: #fff;",'  font-family: "Open Sans", sans-serif;',"  font-size: "+Blockly.Builder.FONT_SIZE+"px;","  font-weight: "+Blockly.Builder.FONT_WEIGHT+";","  word-spacing: "+Blockly.Builder.WORD_SPACING+"px;","}",".blocklyNonEditableText>text {","  pointer-events: none;","}",".blocklyNonEditableText>rect,",".blocklyEditableText>rect {","  fill: #fff;","}",".blocklyEditableText>rect.blocklyCheckIsChecked {","  fill: #331515;","}",".blocklyEditableText.note>rect {",
"  fill: #F0D6E7;","}",".blocklyEditableText.note>rect.blocklyCheckIsChecked {","  fill: #5B4762;","}",".blocklyNonEditableText>text,",".blocklyEditableText>text {","  fill: #000;","}",".blocklyEditableText:hover>rect {","}","/*"," * Don't allow users to select text.  It gets annoying when trying to"," * drag a block and selected text moves instead."," */",".blocklySvg text {","  -moz-user-select: none;","  -webkit-user-select: none;","  user-select: none;","  cursor: inherit;","}","",".blocklyHidden {",
...
"  resize: none;","  background-color: #ffc;","}",".blocklyHtmlInput {","  position: relative;",'  font-family: "Open Sans", sans-serif;',"  font-size: "+Blockly.Builder.FONT_SIZE+"px;","  border: none;","  outline: none;","  height: 18px;","  text-align: center;","  width: 158px;","  top: 2px;","}",".blocklyContextMenuBackground,",".blocklyMutatorBackground {","  fill: #fff;","  stroke-width: 1;","  stroke: #ddd;","}",".blocklyContextMenuOptions>.blocklyMenuDiv,",".blocklyContextMenuOptions>.blocklyMenuDivDisabled,",
".blocklyDropdownMenuOptions>.blocklyMenuDiv {","  fill: #fff;","}",".blocklyContextMenuOptions>.blocklyMenuDiv:hover>rect {","  fill: #57e;","}",".blocklyDropdownMenuOptions>.blocklyMenuDiv:hover>rect {","  fill: #f8acaa;","}",".blocklyMenuSelected>rect {","  fill: #57e;","}",".blocklyMenuText {","  cursor: default !important;",'  font-family: "Open Sans", sans-serif;',"  font-size: 12px; /* All context menu sizes are based on pixels. */","  fill: #000;","}",".blocklyContextMenuOptions>.blocklyMenuDiv:hover>.blocklyMenuText,",
".blocklyDropdownMenuOptions>.blocklyMenuDiv:hover>.blocklyMenuText {","  fill: #fff;","}",".blocklyMenuSelected>.blocklyMenuText {","  fill: #fff;","}",".blocklyMenuDivDisabled>.blocklyMenuText {","  fill: #ccc;","}",".blocklyFlyoutBackground {","  fill: #ddd;","  fill-opacity: 0.8;","}",".blocklyColourBackground {","  fill: #666;","}",".blocklyScrollbarBackground {","  display: none;","  fill: #fff;","  stroke-width: 1;","  stroke: #e4e4e4;","}",".blocklyScrollbarKnob {","  fill: #f0f0f3;","}",
".blocklyScrollbarBackground:hover+.blocklyScrollbarKnob,",".blocklyScrollbarKnob:hover {","  fill: #f0f0f3;","}",".blocklyInvalidInput {","  background: #faa;","}",".blocklyAngleCircle {","  stroke: #444;","  stroke-width: 1;","  fill: #ddd;","  fill-opacity: 0.8;","}",".blocklyAngleMarks {","  stroke: #444;","  stroke-width: 1;","}",".blocklyAngleGauge {","  fill: #f88;","  fill-opacity: 0.8;  ","}",".blocklyAngleLine {","  stroke: #f00;","  stroke-width: 2;","  stroke-linecap: round;","}","","/* Category tree in Toolbox. */",
...
"  color: #fff;","}","","/*"," * Copyright 2007 The Closure Library Authors. All Rights Reserved."," *"," * Use of this source code is governed by the Apache License, Version 2.0."," * See the COPYING file for details."," */","","/* Author: pupius@google.com (Daniel Pupius) */","","/*"," Styles to make the colorpicker look like the old gmail color picker"," NOTE: without CSS scoping this will override styles defined in palette.css","*/",".goog-palette {","  outline: none;","  cursor: default;","}",
"",".goog-palette-table {","  border: 1px solid #666;","  border-collapse: collapse;","}","",".goog-palette-cell {","  height: 18px;","  width: 22px;","  margin: 0;","  border: 0;","  text-align: center;","  vertical-align: middle;","  font-size: 1px;","}","",".goog-palette-colorswatch {","  position: relative;","  height: 18px;","  width: 22px;","  border: 2px solid #fff;","}","",".goog-palette-cell-hover .goog-palette-colorswatch {","  border: 2px solid #fff;","}","",".goog-palette-cell-selected .goog-palette-colorswatch {",
"  border: 2px solid #eee;","  color: #fff;","","}",".trashcan {","  cursor: url(/raw/js/blockly/media/handopen.cur) 8 5, auto;","}",""];Blockly.WidgetDiv={};Blockly.WidgetDiv.DIV=null;Blockly.WidgetDiv.field_=null;Blockly.WidgetDiv.dispose_=null;Blockly.WidgetDiv.show=function(a,b){Blockly.WidgetDiv.hide();Blockly.WidgetDiv.field_=a;Blockly.WidgetDiv.dispose_=b;Blockly.WidgetDiv.DIV.style.display="block"};Blockly.WidgetDiv.hide=function(){Blockly.WidgetDiv.field_&&(Blockly.WidgetDiv.DIV.style.display="none",Blockly.WidgetDiv.dispose_&&Blockly.WidgetDiv.dispose_(),Blockly.WidgetDiv.field_=null,Blockly.WidgetDiv.dispose_=null,goog.dom.removeChildren(Blockly.WidgetDiv.DIV))};
...
a.contentWidth>a.viewWidth+(Blockly.RTL?2:1)*a.viewLeft)for(var b=Blockly.mainWorkspace.getTopBlocks(!1),c=0,d;d=b[c];c++){var e=d.getRelativeToSurfaceXY(),n=d.getHeightWidth(),m=a.viewTop+25-n.height-e.y;0<m&&d.moveBy(0,m);m=a.viewTop+a.viewHeight-25-e.y;0>m&&d.moveBy(0,m);m=25+a.viewLeft-e.x-(Blockly.RTL?0:n.width);0<m&&d.moveBy(m,0);m=a.viewLeft+a.viewWidth-25-e.x+(Blockly.RTL?n.width:0);0>m&&d.moveBy(m,0);d.isDeletable()&&50<(Blockly.RTL?e.x-2*a.viewLeft-a.viewWidth:-e.x)&&d.dispose(!1,!0)}}})));
Blockly.Tooltip&&b.appendChild(Blockly.Tooltip.createDom());!Blockly.readOnly&&Blockly.FieldDropdown&&b.appendChild(Blockly.FieldDropdown.createDom());Blockly.ContextMenu&&Blockly.ContextMenu&&b.appendChild(Blockly.ContextMenu.createDom());a.appendChild(b);Blockly.svg=b;Blockly.svgResize();Blockly.WidgetDiv.DIV=goog.dom.createDom("div","blocklyWidgetDiv");document.body.appendChild(Blockly.WidgetDiv.DIV)};
Blockly.init_=function(){if(goog.userAgent.WEBKIT||goog.userAgent.IE){var a=Blockly.createSvgElement("path",{d:"m 0,0 c 0,-5 0,-5 0,0 H 50 V 50 z"},Blockly.svg);50<a.getBBox().height&&(Blockly.BROKEN_CONTROL_POINTS=!0);Blockly.svg.removeChild(a)}Blockly.bindEvent_(Blockly.svg,"mousedown",null,Blockly.onMouseDown_);Blockly.bindEvent_(Blockly.svg,"mousemove",null,Blockly.onMouseMove_);Blockly.bindEvent_(Blockly.svg,"contextmenu",null,Blockly.onContextMenu_);;Blockly.documentEventsBound_||(Blockly.bindEvent_(window,"resize",document,Blockly.svgResize),Blockly.bindEvent_(document,"mouseup",null,Blockly.onMouseUp_),Blockly.bindEvent_(document,"keydown",null,Blockly.onKeyDown_),goog.userAgent.IPAD&&Blockly.bindEvent_(window,"orientationchange",document,function(){Blockly.fireUiEvent(window,"resize")},!1),Blockly.documentEventsBound_=!0);Blockly.languageTree&&(Blockly.hasCategories?Blockly.Toolbox.init():(Blockly.mainWorkspace.flyout_.init(Blockly.mainWorkspace,
...
Blockly.commonWordSuffix=function(a,b){if(!a.length)return 0;if(1==a.length)return a[0].length;for(var c=0,d=b||Blockly.shortestStringLength(a),e=0;e<d;e++){for(var f=a[0].substr(-e-1,1),g=1;g<a.length;g++)if(f!=a[g].substr(-e-1,1))return c;" "==f&&(c=e+1)}for(g=1;g<a.length;g++)if((f=a[g].charAt(a[g].length-e-1))&&" "!=f)return c;return d};Blockly.isNumber=function(a){return!!a.match(/^\s*-?\d+(\.\d+)?\s*$/)};Blockly.dimmer=function(){Blockly.getMainWorkspace().getAllBlocks().forEach(function(a){var b=a.svg_.svgGroup_;b.setAttribute("opacity","1");a.isSticky||null!=a.getParent()||b.setAttribute("opacity","0.7")})};Blockly.pathToBlockly="./";Blockly.SVG_NS="http://www.w3.org/2000/svg";Blockly.HTML_NS="http://www.w3.org/1999/xhtml";Blockly.HSV_SATURATION=0.45;Blockly.HSV_VALUE=0.65;Blockly.makeColour=function(a){return goog.color.hsvToHex(a,Blockly.HSV_SATURATION,256*Blockly.HSV_VALUE)};Blockly.INPUT_VALUE=1;Blockly.OUTPUT_VALUE=2;Blockly.NEXT_STATEMENT=3;Blockly.PREVIOUS_STATEMENT=4;Blockly.DUMMY_INPUT=5;Blockly.ALIGN_LEFT=-1;Blockly.ALIGN_CENTRE=0;Blockly.ALIGN_RIGHT=1;Blockly.OPPOSITE_TYPE=[];
Blockly.OPPOSITE_TYPE[Blockly.INPUT_VALUE]=Blockly.OUTPUT_VALUE;Blockly.OPPOSITE_TYPE[Blockly.OUTPUT_VALUE]=Blockly.INPUT_VALUE;Blockly.OPPOSITE_TYPE[Blockly.NEXT_STATEMENT]=Blockly.PREVIOUS_STATEMENT;Blockly.OPPOSITE_TYPE[Blockly.PREVIOUS_STATEMENT]=Blockly.NEXT_STATEMENT;Blockly.TYPE_RULES=[];var objectBlockly={type:Blockly.INPUT_VALUE,strategy:"NotExistAsAtTopLevel"};
Blockly.TYPE_RULES.animation=Blockly.TYPE_RULES.art=Blockly.TYPE_RULES.music=Blockly.TYPE_RULES.robots=Blockly.TYPE_RULES.dance=Blockly.TYPE_RULES.games=Blockly.TYPE_RULES.fashion=Blockly.TYPE_RULES.maps=objectBlockly;Blockly.TYPE_RULES.math_number=Blockly.TYPE_RULES.math_number2={type:Blockly.INPUT_VALUE,strategy:"InlineTrapezoid"};var background={type:Blockly.INPUT_VALUE,strategy:"VerticalTrapezoid"};Blockly.TYPE_RULES.background=Blockly.TYPE_RULES.move=background;
Blockly.TYPE_RULES.images=Blockly.TYPE_RULES.music_shapes={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTrapezoid"};var accessory={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTriangle"};Blockly.TYPE_RULES.face=Blockly.TYPE_RULES.bodywear=Blockly.TYPE_RULES.frame=Blockly.TYPE_RULES.diameter=Blockly.TYPE_RULES.width=Blockly.TYPE_RULES.message=Blockly.TYPE_RULES.color=accessory;var shape={type:Blockly.NEXT_STATEMENT,strategy:"DoubleBox"};Blockly.TYPE_RULES.measure={type:Blockly.NEXT_STATEMENT,strategy:"DoubleBox"};
Blockly.TYPE_RULES.parameters={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTriangle"};Blockly.TYPE_RULES["doodles 1"]=Blockly.TYPE_RULES["doodles 2"]=Blockly.TYPE_RULES.shape=shape;Blockly.TYPE_RULES.colour_picker=Blockly.TYPE_RULES.color_picker=Blockly.TYPE_RULES.color_picker2=Blockly.TYPE_RULES.color_picker3=Blockly.TYPE_RULES.color_picker4=Blockly.TYPE_RULES.silver=Blockly.TYPE_RULES.yellow=Blockly.TYPE_RULES.green={type:Blockly.INPUT_VALUE,strategy:"InlineBox"};
Blockly.TYPE_RULES.text=Blockly.TYPE_RULES.prefilled_text={type:Blockly.INPUT_VALUE,strategy:"InlineString"};var nexus={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTriangle"};Blockly.TYPE_RULES.image=Blockly.TYPE_RULES.kaleidoscope=Blockly.TYPE_RULES.yeti=Blockly.TYPE_RULES.sound_ring=Blockly.TYPE_RULES.tracer=Blockly.TYPE_RULES.games_move=Blockly.TYPE_RULES.games_turn=nexus;
Blockly.TYPE_RULES.dance=Blockly.TYPE_RULES.fashion=Blockly.TYPE_RULES.fashion_circle=Blockly.TYPE_RULES.connector=Blockly.TYPE_RULES.tracer={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTriangle",inCheck:["Generator"]};var actions={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTrapezoid"};Blockly.TYPE_RULES.move=Blockly.TYPE_RULES.actions_dance=Blockly.TYPE_RULES.actions_wave=Blockly.TYPE_RULES.actions_entrance=Blockly.TYPE_RULES.actions_exit=Blockly.TYPE_RULES.actions_head_spin=actions;
var robots={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTriangle"};Blockly.TYPE_RULES.actions_add_water=Blockly.TYPE_RULES.actions_move_right=Blockly.TYPE_RULES.logic_repeat=Blockly.TYPE_RULES.logic_if_needs_water=robots;var dance={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTriangle",inCheck:["Inside"]};Blockly.TYPE_RULES.start_position=Blockly.TYPE_RULES.tracer_shape=dance;Blockly.TYPE_RULES.tracer_size={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTriangle",inCheck:["SizeInside"]};
Blockly.TYPE_RULES.tracer_joint={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTrapezoid"};var colours={type:Blockly.INPUT_VALUE,strategy:"InlineBox"};
Blockly.TYPE_RULES.color_485a96=Blockly.TYPE_RULES.color_8e3fb7=Blockly.TYPE_RULES.color_be3535=Blockly.TYPE_RULES.color_473737=Blockly.TYPE_RULES.color_526d21=Blockly.TYPE_RULES.color_80b6c7=Blockly.TYPE_RULES.color_red=Blockly.TYPE_RULES.color_yellow=Blockly.TYPE_RULES.color_blue=Blockly.TYPE_RULES.color_green=Blockly.TYPE_RULES.color_purple=Blockly.TYPE_RULES.color_white=Blockly.TYPE_RULES.color_ffffff=Blockly.TYPE_RULES.color_f54242=Blockly.TYPE_RULES.color_cdf542=Blockly.TYPE_RULES.color_7dafd0=
Blockly.TYPE_RULES.color_7ccf6e=Blockly.TYPE_RULES.color_7d8bbc=colours;var maps={type:Blockly.NEXT_STATEMENT,strategy:"VerticalTriangle"};Blockly.TYPE_RULES.logic_repeat_until_marker=Blockly.TYPE_RULES.logic_if_can_turn=Blockly.TYPE_RULES.actions_move_forward=Blockly.TYPE_RULES.actions_turn=maps;Blockly.SOUNDS_=Object.create(null);Blockly.selected=null;Blockly.readOnly=!1;Blockly.highlightedConnection_=null;Blockly.localConnection_=null;Blockly.DRAG_RADIUS=5;Blockly.SNAP_RADIUS=50;
Blockly.BUMP_DELAY=250;Blockly.COLLAPSE_CHARS=30;Blockly.SCROLL_SPEED=3;Blockly.MAX_WORKSPACE_HEIGHT=1500;Blockly.mainWorkspace=null;Blockly.clipboard_=null;Blockly.svgSize=function(){return{width:Blockly.svg.cachedWidth_,height:Blockly.svg.cachedHeight_}};
...
Blockly.onMouseDown_=function(a){Blockly.terminateDrag_();Blockly.hideChaff();var b=a.target&&a.target.nodeName&&"svg"==a.target.nodeName.toLowerCase();!Blockly.readOnly&&Blockly.selected&&b&&Blockly.selected.unselect();Blockly.isRightButton(a)?Blockly.ContextMenu&&Blockly.showContextMenu_(Blockly.mouseToSvg(a)):(Blockly.readOnly||b)&&Blockly.mainWorkspace.scrollbar&&(Blockly.mainWorkspace.dragMode=!0,Blockly.mainWorkspace.startDragMouseX=a.clientX,Blockly.mainWorkspace.startDragMouseY=a.clientY,
Blockly.mainWorkspace.startDragMetrics=Blockly.mainWorkspace.getMetrics(),Blockly.mainWorkspace.startScrollX=Blockly.mainWorkspace.scrollX,Blockly.mainWorkspace.startScrollY=Blockly.mainWorkspace.scrollY,Blockly.mainWorkspace.startScrollPosition=Blockly.getScrollPosition())};Blockly.getScrollPosition=function(){return parseInt(Blockly.mainWorkspace.scrollbar.vScroll.svgKnob_.getAttribute("y"))};Blockly.onMouseUp_=function(a){Blockly.setCursorHand_(!1);Blockly.mainWorkspace.dragMode=!1};
Blockly.onMouseMove_=function(a){if(Blockly.mainWorkspace.dragMode){Blockly.removeAllRanges();var b=a.clientY-Blockly.mainWorkspace.startDragMouseY;Blockly.mainWorkspace.startDragMouseY=a.clientY;a=Blockly.mainWorkspace.startDragMetrics;b=Blockly.getScrollPosition()-b;b=Math.max(b,a.viewHeight-a.contentTop-a.contentHeight);b=Math.max(0,b);Blockly.mainWorkspace.scrollbar.set(0,b)}};Blockly.onScroll_=function(a){a.preventDefault();a.stopPropagation();0<a.deltaY?Blockly.scrollSouth():Blockly.scrollNorth()};
Blockly.scrollSouth=function(){Blockly.hideChaff();Blockly.WidgetDiv.hide();Blockly.selected&&Blockly.selected.unselect();var a=parseInt(Blockly.mainWorkspace.scrollbar.vScroll.svgKnob_.getAttribute("y")),b=Blockly.getMainWorkspaceMetrics_().viewHeight,c=parseInt(Blockly.mainWorkspace.scrollbar.vScroll.svgKnob_.getAttribute("height")),a=Math.min(b-c,a+Blockly.getScrollSpeed());Blockly.mainWorkspace.scrollbar.set(0,a)};
Blockly.scrollNorth=function(){Blockly.hideChaff();Blockly.WidgetDiv.hide();Blockly.selected&&Blockly.selected.unselect();var a=parseInt(Blockly.mainWorkspace.scrollbar.vScroll.svgKnob_.getAttribute("y")),a=Math.max(0,a-Blockly.getScrollSpeed());Blockly.mainWorkspace.scrollbar.set(0,a)};Blockly.getScrollSpeed=function(){var a=Blockly.getMainWorkspaceMetrics_().viewHeight,b=parseInt(Blockly.mainWorkspace.scrollbar.vScroll.svgKnob_.getAttribute("height"));return(a-b)/100*Blockly.SCROLL_SPEED};
Blockly.onKeyDown_=function(a){if(!Blockly.isTargetInput_(a))if(27==a.keyCode)Blockly.hideChaff();else if(a.altKey||a.ctrlKey||a.metaKey)Blockly.selected&&Blockly.selected.isDeletable()&&Blockly.selected.workspace==Blockly.mainWorkspace&&(Blockly.hideChaff(),67==a.keyCode?Blockly.copy_(Blockly.selected):88==a.keyCode&&(Blockly.copy_(Blockly.selected),Blockly.selected.dispose(!0,!0))),86==a.keyCode&&Blockly.clipboard_&&Blockly.mainWorkspace.paste(Blockly.clipboard_)};
Blockly.terminateDrag_=function(){Blockly.Block.terminateDrag_();Blockly.Flyout.terminateDrag_()};Blockly.copy_=function(a){var b=Blockly.Xml.blockToDom_(a);Blockly.Xml.deleteNext(b);a=a.getRelativeToSurfaceXY();b.setAttribute("x",Blockly.RTL?-a.x:a.x);b.setAttribute("y",a.y);Blockly.clipboard_=b};
...
b.push(c);Blockly.ContextMenu.show(a,b)}};Blockly.onContextMenu_=function(a){!Blockly.isTargetInput_(a)&&Blockly.ContextMenu&&a.preventDefault()};Blockly.hideChaff=function(a){Blockly.Tooltip&&Blockly.Tooltip.hide();Blockly.ContextMenu&&Blockly.ContextMenu.hide();Blockly.FieldDropdown&&Blockly.FieldDropdown.hide();Blockly.WidgetDiv.hide();!a&&Blockly.Toolbox.flyout_&&Blockly.Toolbox.flyout_.autoClose&&Blockly.Toolbox.clearSelection()};
Blockly.removeAllRanges=function(){if(window.getSelection){var a=window.getSelection();a&&a.removeAllRanges&&(a.removeAllRanges(),window.setTimeout(function(){window.getSelection().removeAllRanges()},0))}};Blockly.isTargetInput_=function(a){return"textarea"==a.target.type||"text"==a.target.type};
Blockly.loadAudio_=function(a,b){if(window.Audio&&a.length){for(var c,d=new window.Audio,e=0;e<a.length;e++){var f=a[e],g=f.match(/\.(\w+)$/);if(g&&d.canPlayType("audio/"+g[1])){c=new window.Audio(Blockly.pathToBlockly+f);break}}c&&c.play&&(c.volume=0.01,c.play(),Blockly.SOUNDS_[b]=c)}};Blockly.playAudio=function(a,b){var c=Blockly.SOUNDS_[a];c&&(c=goog.userAgent.DOCUMENT_MODE&&9===goog.userAgent.DOCUMENT_MODE||goog.userAgent.IPAD||goog.userAgent.ANDROID?c:c.cloneNode(),c.volume=void 0===b?1:b,c.play())};
Blockly.setCursorHand_=function(a){Blockly.readOnly||(Blockly.setCursorHand_=function(a){Blockly.readOnly||(a?(Blockly.selected&&Blockly.selected.getSvgRoot().setAttribute("class",Blockly.selected.getSvgRoot().getAttribute("class")+" closed"),Blockly.svg.setAttribute("class",Blockly.svg.getAttribute("class")+" closed")):(Blockly.selected&&Blockly.selected.getSvgRoot().setAttribute("class",Blockly.selected.getSvgRoot().getAttribute("class").replace(" closed","")),Blockly.svg.setAttribute("class",Blockly.svg.getAttribute("class").replace(" closed",
""))))})};
Blockly.getMainWorkspaceMetrics_=function(){var a=Blockly.svgSize();a.width-=Blockly.Toolbox.width;var b=a.width-Blockly.Scrollbar.scrollbarThickness,c=a.height-Blockly.Scrollbar.scrollbarThickness;try{var d=Blockly.mainWorkspace.getCanvas().getBBox()}catch(e){return null}Blockly.mainWorkspace.scrollbar?(Math.min(d.x-b/2,d.x+d.width-b),Math.max(d.x+d.width+b/2,d.x+b),b=Math.min(d.y-c/2,d.y+d.height-c),d=Math.max(c,d.height)):(b=d.y,d=b+d.height);var f=Blockly.RTL?0:Blockly.Toolbox.width,g=0;Blockly.getMainWorkspace().getTopBlocks().forEach(function(a){a.isSticky&&
(g=a.getSvgRoot().getBBox().height+200)});g=Math.max(g,c);return{viewHeight:a.height,viewWidth:a.width,contentHeight:d-b,contentWidth:a.width,viewTop:-Blockly.mainWorkspace.scrollY,viewLeft:0,contentTop:0,contentLeft:0,absoluteTop:0,absoluteLeft:f}};
...
a);Blockly.mainWorkspace.getBubbleCanvas().setAttribute("transform",a)};Blockly.addChangeListener=function(a){return Blockly.bindEvent_(Blockly.mainWorkspace.getCanvas(),"blocklyWorkspaceChange",null,a)};Blockly.addImmediateChangeListener=function(a){return Blockly.bindEvent_(Blockly.mainWorkspace.getCanvas(),"immediateBlocklyWorkspaceChange",null,a)};Blockly.removeChangeListener=function(a){Blockly.unbindEvent_(a)};Blockly.getMainWorkspace=function(){return Blockly.mainWorkspace};
window.Blockly=Blockly;Blockly.getMainWorkspace=Blockly.getMainWorkspace;Blockly.addChangeListener=Blockly.addChangeListener;Blockly.removeChangeListener=Blockly.removeChangeListener;Blockly.Blocks.colour={};
window.Blockly.Blocks.colour_picker={desiredStrategy:"color_picker",hasSelection:!1,setContents:function(a){this.inputList[0].titleRow[0].setValue(a);this.hasSelection=!0},init:function(){var a=this;this.setHelpUrl(Blockly.Msg.COLOUR_PICKER_HELPURL);this.setColour("#2691b3");this.appendDummyInput().appendTitle(new Blockly.FieldColour("#ff0000",function(b){a.hasSelection=!0}),"COLOUR");this.setOutput(!0,"Colour");this.setTooltip(Blockly.Msg.COLOUR_PICKER_TOOLTIP);this.hasBeenSelected=!1}};
Blockly.Blocks.colour_random={init:function(){this.setHelpUrl(Blockly.Msg.COLOUR_RANDOM_HELPURL);this.setColour(20);this.appendDummyInput().appendTitle(Blockly.Msg.COLOUR_RANDOM_TITLE);this.setOutput(!0,"Colour");this.setTooltip(Blockly.Msg.COLOUR_RANDOM_TOOLTIP)}};
...
Blockly.Blocks.lists_create_with_container={init:function(){this.setColour(260);this.appendDummyInput().appendTitle(Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD);this.appendStatementInput("STACK");this.setTooltip(Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP);this.contextMenu=!1}};
Blockly.Blocks.lists_create_with_item={init:function(){this.setColour(260);this.appendDummyInput().appendTitle(Blockly.Msg.LISTS_CREATE_WITH_ITEM_TITLE);this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP);this.contextMenu=!1}};
...
this.appendValueInput("LIST").setCheck("Array").appendTitle(Blockly.Msg.LISTS_GET_SUBLIST_INPUT_IN_LIST);this.appendDummyInput("AT1");this.appendDummyInput("AT2");Blockly.Msg.LISTS_GET_SUBLIST_TAIL&&this.appendDummyInput("TAIL").appendTitle(Blockly.Msg.LISTS_GET_SUBLIST_TAIL);this.setInputsInline(!0);this.setOutput(!0,"Array");this.updateAt(1,!0);this.updateAt(2,!0);this.setTooltip(Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP)},mutationToDom:function(){var a=document.createElement("mutation"),b=this.getInput("AT1").type==
...
this.appendDummyInput("AT"+a);var c=new Blockly.FieldDropdown(this["WHERE_OPTIONS_"+a],function(c){var e="FROM_START"==c||"FROM_END"==c;if(e!=b){var f=this.sourceBlock_;f.updateAt(a,e);f.setTitleValue(c,"WHERE"+a);return null}});this.getInput("AT"+a).appendTitle(c,"WHERE"+a);1==a&&(this.moveInputBefore("AT1","AT2"),this.getInput("ORDINAL1")&&this.moveInputBefore("ORDINAL1","AT2"));Blockly.Msg.LISTS_GET_SUBLIST_TAIL&&this.moveInputBefore("TAIL",null)}};Blockly.Blocks.logic={};
...
Blockly.Blocks.controls_if_elseif={init:function(){this.setColour(210);this.appendDummyInput().appendTitle(Blockly.Msg.CONTROLS_IF_ELSEIF_TITLE_ELSEIF);this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP);this.contextMenu=!1}};
Blockly.Blocks.controls_if_else={init:function(){this.setColour(210);this.appendDummyInput().appendTitle(Blockly.Msg.CONTROLS_IF_ELSE_TITLE_ELSE);this.setPreviousStatement(!0);this.setTooltip(Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP);this.contextMenu=!1}};
...
Blockly.Blocks.logic_boolean={init:function(){var a=[[Blockly.Msg.LOGIC_BOOLEAN_TRUE,"TRUE"],[Blockly.Msg.LOGIC_BOOLEAN_FALSE,"FALSE"]];this.setHelpUrl(Blockly.Msg.LOGIC_BOOLEAN_HELPURL);this.setColour(210);this.setOutput(!0,"Boolean");this.appendDummyInput().appendTitle(new Blockly.FieldDropdown(a),"BOOL");this.setTooltip(Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP)}};
Blockly.Blocks.logic_null={init:function(){this.setHelpUrl(Blockly.Msg.LOGIC_NULL_HELPURL);this.setColour(210);this.setOutput(!0);this.appendDummyInput().appendTitle(Blockly.Msg.LOGIC_NULL);this.setTooltip(Blockly.Msg.LOGIC_NULL_TOOLTIP)}};
...
Blockly.Blocks.controls_flow_statements={init:function(){var a=[[Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK,"BREAK"],[Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE,"CONTINUE"]];this.setHelpUrl(Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL);this.setColour(120);this.appendDummyInput().appendTitle(new Blockly.FieldDropdown(a),"FLOW");this.setPreviousStatement(!0);var b=this;this.setTooltip(function(){var a=b.getTitleValue("FLOW");return b.TOOLTIPS[a]})},onchange:function(){if(this.workspace){var a=
!1,b=this;do{if("controls_repeat"==b.type||"controls_repeat_ext"==b.type||"controls_forEach"==b.type||"controls_for"==b.type||"controls_whileUntil"==b.type){a=!0;break}b=b.getSurroundParent()}while(b);a?this.setWarningText(null):this.setWarningText(Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING)}}};Blockly.Blocks.math={};
Blockly.Blocks.math_number={desiredWidth:40,desiredStrategy:"number",setContents:function(a){this.inputList[0].titleRow[0].setValue(""+a)},init:function(){this.setHelpUrl(Blockly.Msg.MATH_NUMBER_HELPURL);this.setColour("#2691b3");this.appendDummyInput().appendTitle(new Blockly.FieldNumberInput("0"),"NUM");this.setOutput(!0,"Number");this.setTooltip(Blockly.Msg.MATH_NUMBER_TOOLTIP)},disallowEditing:function(){this.inputList[0].titleRow[0].showEditor_=function(){};this.inputList[0].titleRow[0].fieldGroup_.style.cursor=""}};
Blockly.Blocks.math_number2=Blockly.Blocks.math_number;
Blockly.Blocks.math_arithmetic={init:function(){var a=[[Blockly.Msg.MATH_ADDITION_SYMBOL,"ADD"],[Blockly.Msg.MATH_SUBTRACTION_SYMBOL,"MINUS"],[Blockly.Msg.MATH_MULTIPLICATION_SYMBOL,"MULTIPLY"],[Blockly.Msg.MATH_DIVISION_SYMBOL,"DIVIDE"],[Blockly.Msg.MATH_POWER_SYMBOL,"POWER"]];this.setHelpUrl(Blockly.Msg.MATH_ARITHMETIC_HELPURL);this.setColour("#2691b3");this.setOutput(!0,"Number");this.appendValueInput("A").setCheck("Number");this.appendValueInput("B").setCheck("Number").appendTitle(new Blockly.FieldDropdown(a),"OP");
...
getProcedureDef:function(){return[this.getTitleValue("NAME"),this.arguments_,!0]},getVars:Blockly.Blocks.procedures_defnoreturn.getVars,renameVar:Blockly.Blocks.procedures_defnoreturn.renameVar,customContextMenu:Blockly.Blocks.procedures_defnoreturn.customContextMenu,callType_:"procedures_callreturn"};
Blockly.Blocks.procedures_mutatorcontainer={init:function(){this.setColour(290);this.appendDummyInput().appendTitle(Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE);this.appendStatementInput("STACK");this.setTooltip("");this.contextMenu=!1}};
...
Blockly.Blocks.procedures_callnoreturn={init:function(){this.setHelpUrl(Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL);this.setColour(290);this.appendDummyInput().appendTitle(Blockly.Msg.PROCEDURES_CALLNORETURN_CALL).appendTitle("","NAME");this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP);this.arguments_=[];this.quarkArguments_=this.quarkConnections_=null},getProcedureCall:function(){return this.getTitleValue("NAME")},renameProcedure:function(a,
b){Blockly.Names.equals(a,this.getTitleValue("NAME"))&&(this.setTitleValue(b,"NAME"),this.setTooltip((this.outputConnection?Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP:Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP).replace("%1",b)))},setProcedureParameters:function(a,b){if(b){if(b.length!=a.length)throw"Error: paramNames and paramIds must be the same length.";this.quarkArguments_||(this.quarkConnections_={},a.join("\n")==this.arguments_.join("\n")?this.quarkArguments_=b:this.quarkArguments_=[]);var c=
...
a.getAttribute("name");this.setTitleValue(b,"NAME");this.setTooltip((this.outputConnection?Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP:Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP).replace("%1",b));if((b=Blockly.Procedures.getDefinition(b,this.workspace))&&b.mutator.isVisible())this.setProcedureParameters(b.arguments_,b.paramIds_);else{this.arguments_=[];for(var b=0,c;c=a.childNodes[b];b++)"arg"==c.nodeName.toLowerCase()&&this.arguments_.push(c.getAttribute("name"));this.setProcedureParameters(this.arguments_,
this.arguments_)}},renameVar:function(a,b){for(var c=0;c<this.arguments_.length;c++)Blockly.Names.equals(a,this.arguments_[c])&&(this.arguments_[c]=b,this.getInput("ARG"+c).titleRow[0].setText(b))},customContextMenu:function(a){var b={enabled:!0};b.text=Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF;var c=this.getTitleValue("NAME"),d=this.workspace;b.callback=function(){var a=Blockly.Procedures.getDefinition(c,d);a&&a.select()};a.push(b)}};
Blockly.Blocks.procedures_callreturn={init:function(){this.setHelpUrl(Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL);this.setColour(290);this.appendDummyInput().appendTitle(Blockly.Msg.PROCEDURES_CALLRETURN_CALL).appendTitle("","NAME");this.setOutput(!0);this.setTooltip(Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP);this.arguments_=[];this.quarkArguments_=this.quarkConnections_=null},getProcedureCall:Blockly.Blocks.procedures_callnoreturn.getProcedureCall,renameProcedure:Blockly.Blocks.procedures_callnoreturn.renameProcedure,
...
document.createElement("mutation");a.setAttribute("value",Number(this.hasReturnValue_));return a},domToMutation:function(a){this.hasReturnValue_=1==a.getAttribute("value");this.hasReturnValue_||(this.removeInput("VALUE"),this.appendDummyInput("VALUE").appendTitle(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN))},onchange:function(){if(this.workspace){var a=!1,b=this;do{if("procedures_defnoreturn"==b.type||"procedures_defreturn"==b.type){a=!0;break}b=b.getSurroundParent()}while(b);a?("procedures_defnoreturn"==
b.type&&this.hasReturnValue_?(this.removeInput("VALUE"),this.appendDummyInput("VALUE").appendTitle(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN),this.hasReturnValue_=!1):"procedures_defreturn"!=b.type||this.hasReturnValue_||(this.removeInput("VALUE"),this.appendValueInput("VALUE").appendTitle(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN),this.hasReturnValue_=!0),this.setWarningText(null)):this.setWarningText(Blockly.Msg.PROCEDURES_IFRETURN_WARNING)}}};Blockly.Blocks.text={};Blockly.Blocks.text={desiredStrategy:"text",init:function(){this.setColour("#2691b3");this.appendDummyInput().appendTitle(new Blockly.FieldTextInput(""),"TEXT");this.setOutput(!0,"String")}};
...
Blockly.Blocks.text_prompt={init:function(){var a=[[Blockly.Msg.TEXT_PROMPT_TYPE_TEXT,"TEXT"],[Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER,"NUMBER"]],b=this;this.setHelpUrl(Blockly.Msg.TEXT_PROMPT_HELPURL);this.setColour(160);a=new Blockly.FieldDropdown(a,function(a){"NUMBER"==a?b.outputConnection.setCheck("Number"):b.outputConnection.setCheck("String")});this.appendDummyInput().appendTitle(a,"TYPE").appendTitle(new Blockly.FieldImage(Blockly.pathToBlockly+"media/quote0.png",12,12)).appendTitle(new Blockly.FieldTextInput(""),
"TEXT").appendTitle(new Blockly.FieldImage(Blockly.pathToBlockly+"media/quote1.png",12,12));this.setOutput(!0,"String");b=this;this.setTooltip(function(){return"TEXT"==b.getTitleValue("TYPE")?Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT:Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER})}};Blockly.Blocks.variables={};
Blockly.Blocks.variables_get={init:function(){this.setHelpUrl(Blockly.Msg.VARIABLES_GET_HELPURL);this.setColour(330);this.appendDummyInput().appendTitle(Blockly.Msg.VARIABLES_GET_TITLE).appendTitle(new Blockly.FieldVariable(Blockly.Msg.VARIABLES_GET_ITEM),"VAR").appendTitle(Blockly.Msg.VARIABLES_GET_TAIL);this.setOutput(!0);this.setTooltip(Blockly.Msg.VARIABLES_GET_TOOLTIP);this.contextMenuMsg_=Blockly.Msg.VARIABLES_GET_CREATE_SET;this.contextMenuType_="variables_set"},getVars:function(){return[this.getTitleValue("VAR")]},
renameVar:function(a,b){Blockly.Names.equals(a,this.getTitleValue("VAR"))&&this.setTitleValue(b,"VAR")},customContextMenu:function(a){var b={enabled:!0},c=this.getTitleValue("VAR");b.text=this.contextMenuMsg_.replace("%1",c);c=goog.dom.createDom("title",null,c);c.setAttribute("name","VAR");c=goog.dom.createDom("block",null,c);c.setAttribute("type",this.contextMenuType_);b.callback=Blockly.ContextMenu.callbackFactory(this,c);a.push(b)}};
Blockly.Blocks.variables_set={init:function(){this.setHelpUrl(Blockly.Msg.VARIABLES_SET_HELPURL);this.setColour(330);this.appendValueInput("VALUE").appendTitle(Blockly.Msg.VARIABLES_SET_TITLE).appendTitle(new Blockly.FieldVariable(Blockly.Msg.VARIABLES_SET_ITEM),"VAR").appendTitle(Blockly.Msg.VARIABLES_SET_TAIL);this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.Msg.VARIABLES_SET_TOOLTIP);this.contextMenuMsg_=Blockly.Msg.VARIABLES_SET_CREATE_GET;this.contextMenuType_=
"variables_get"},getVars:function(){return[this.getTitleValue("VAR")]},renameVar:function(a,b){Blockly.Names.equals(a,this.getTitleValue("VAR"))&&this.setTitleValue(b,"VAR")},customContextMenu:Blockly.Blocks.variables_get.customContextMenu};Blockly.Msg.en={};Blockly.Msg.ADD_COMMENT="Add Comment";Blockly.Msg.CHANGE_VALUE_TITLE="Change value:";Blockly.Msg.COLLAPSE_ALL="Collapse Blocks";Blockly.Msg.COLLAPSE_BLOCK="Collapse Block";Blockly.Msg.COLOUR_BLEND_COLOUR1="colour 1";Blockly.Msg.COLOUR_BLEND_COLOUR2="colour 2";Blockly.Msg.COLOUR_BLEND_HELPURL="http://meyerweb.com/eric/tools/color-blend/";Blockly.Msg.COLOUR_BLEND_RATIO="ratio";Blockly.Msg.COLOUR_BLEND_TITLE="blend";Blockly.Msg.COLOUR_BLEND_TOOLTIP="Blends two colours together with a given ratio (0.0 - 1.0).";
Blockly.Msg.COLOUR_PICKER_HELPURL="https://en.wikipedia.org/wiki/Color";Blockly.Msg.COLOUR_PICKER_TOOLTIP="Choose a colour from the palette.";Blockly.Msg.COLOUR_RANDOM_HELPURL="http://randomcolour.com";Blockly.Msg.COLOUR_RANDOM_TITLE="random colour";Blockly.Msg.COLOUR_RANDOM_TOOLTIP="Choose a colour at random.";Blockly.Msg.COLOUR_RGB_BLUE="blue";Blockly.Msg.COLOUR_RGB_GREEN="green";Blockly.Msg.COLOUR_RGB_HELPURL="http://www.december.com/html/spec/colorper.html";Blockly.Msg.COLOUR_RGB_RED="red";
Blockly.Msg.COLOUR_RGB_TITLE="colour with";Blockly.Msg.COLOUR_RGB_TOOLTIP="Create a colour with the specified amount of red, green, and blue.  All values must be between 0 and 100.";Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL="https://code.google.com/p/blockly/wiki/Loops#Loop_Termination_Blocks";Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK="break out of loop";Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE="continue with next iteration of loop";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK="Break out of the containing loop.";Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE="Skip the rest of this loop, and continue with the next iteration.";Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING="Warning: This block may only be used within a loop.";Blockly.Msg.CONTROLS_FOREACH_HELPURL="https://code.google.com/p/blockly/wiki/Loops#for_each for each block";Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST="in list";
...
Blockly.Msg.LISTS_GET_INDEX_GET_REMOVE="get and remove";Blockly.Msg.LISTS_GET_INDEX_LAST="last";Blockly.Msg.LISTS_GET_INDEX_RANDOM="random";Blockly.Msg.LISTS_GET_INDEX_REMOVE="remove";Blockly.Msg.LISTS_GET_INDEX_TAIL="";Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST="Returns the first item in a list.";Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END="Returns the item at the specified position in a list.  #1 is the last item.";Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START="Returns the item at the specified position in a list.  #1 is the first item.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST="Returns the last item in a list.";Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM="Returns a random item in a list.";Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST="Removes and returns the first item in a list.";Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END="Removes and returns the item at the specified position in a list.  #1 is the last item.";Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START="Removes and returns the item at the specified position in a list.  #1 is the first item.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST="Removes the last item in a list.";Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM="Removes a random item in a list.";Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_END="to # from end";Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_START="to #";Blockly.Msg.LISTS_GET_SUBLIST_END_LAST="to last";Blockly.Msg.LISTS_GET_SUBLIST_HELPURL="https://code.google.com/p/blockly/wiki/Lists#Getting_a_sublist";Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST="get sub-list from first";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END="get sub-list from # from end";Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START="get sub-list from #";Blockly.Msg.LISTS_GET_SUBLIST_TAIL="";Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP="Creates a copy of the specified portion of a list.";Blockly.Msg.LISTS_INDEX_OF_FIRST="find first occurrence of item";Blockly.Msg.LISTS_INDEX_OF_HELPURL="https://code.google.com/p/blockly/wiki/Lists#Getting_Items_from_a_List";Blockly.Msg.LISTS_INDEX_OF_LAST="find last occurrence of item";
...
Blockly.Msg.MATH_ADDITION_SYMBOL="+";Blockly.Msg.MATH_ARITHMETIC_HELPURL="https://en.wikipedia.org/wiki/Arithmetic";Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD="Return the sum of the two numbers.";Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE="Return the quotient of the two numbers.";Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS="Return the difference of the two numbers.";Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY="Return the product of the two numbers.";Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER="Return the first number raised to the power of the second number.";
Blockly.Msg.MATH_CHANGE_HELPURL="https://en.wikipedia.org/wiki/Programming_idiom#Incrementing_a_counter";Blockly.Msg.MATH_CHANGE_INPUT_BY="by";Blockly.Msg.MATH_CHANGE_TITLE_CHANGE="change";Blockly.Msg.MATH_CHANGE_TOOLTIP="Add a number to variable '%1'.";Blockly.Msg.MATH_CONSTANT_HELPURL="https://en.wikipedia.org/wiki/Mathematical_constant";Blockly.Msg.MATH_CONSTANT_TOOLTIP="Return one of the common constants: \u03c0 (3.141\u2026), e (2.718\u2026), \u03c6 (1.618\u2026), sqrt(2) (1.414\u2026), sqrt(\u00bd) (0.707\u2026), or \u221e (infinity).";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN="Return the sine of a degree (not radian).";Blockly.Msg.MATH_TRIG_TOOLTIP_TAN="Return the tangent of a degree (not radian).";Blockly.Msg.NEW_VARIABLE="New variable...";Blockly.Msg.NEW_VARIABLE_TITLE="New variable name:";Blockly.Msg.ORDINAL_NUMBER_SUFFIX="";Blockly.Msg.PROCEDURES_BEFORE_PARAMS="with:";Blockly.Msg.PROCEDURES_CALLNORETURN_CALL="";Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL="https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP="Run the user-defined function '%1'.";Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL="https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP="Run the user-defined function '%1' and use its output.";Blockly.Msg.PROCEDURES_CREATE_DO="Create '%1'";Blockly.Msg.PROCEDURES_DEFNORETURN_DO="";Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL="https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE="do something";Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE="to";Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP="Creates a function with no output.";Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL="https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";Blockly.Msg.PROCEDURES_DEFRETURN_RETURN="return";Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP="Creates a function with an output.";Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING="Warning: This function has duplicate parameters.";
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF="Highlight function definition";Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP="If a value is true, then return a second value.";Blockly.Msg.PROCEDURES_IFRETURN_WARNING="Warning: This block may be used only within a function definition.";Blockly.Msg.PROCEDURES_MUTATORARG_TITLE="input name:";Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE="inputs";Blockly.Msg.REMOVE_COMMENT="Remove Comment";Blockly.Msg.RENAME_VARIABLE="Rename variable...";
Blockly.Msg.RENAME_VARIABLE_TITLE="Rename all '%1' variables to:";Blockly.Msg.TEXT_APPEND_APPENDTEXT="append text";Blockly.Msg.TEXT_APPEND_HELPURL="https://code.google.com/p/blockly/wiki/Text#Text_modification";Blockly.Msg.TEXT_APPEND_TO="to";Blockly.Msg.TEXT_APPEND_TOOLTIP="Append some text to variable '%1'.";Blockly.Msg.TEXT_CHANGECASE_HELPURL="https://code.google.com/p/blockly/wiki/Text#Adjusting_text_case";Blockly.Msg.TEXT_CHANGECASE_OPERATOR_LOWERCASE="to lower case";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE="to Title Case";Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE="to UPPER CASE";Blockly.Msg.TEXT_CHANGECASE_TOOLTIP="Return a copy of the text in a different case.";Blockly.Msg.TEXT_CHARAT_FIRST="get first letter";Blockly.Msg.TEXT_CHARAT_FROM_END="get letter # from end";Blockly.Msg.TEXT_CHARAT_FROM_START="get letter #";Blockly.Msg.TEXT_CHARAT_HELPURL="https://code.google.com/p/blockly/wiki/Text#Extracting_text";Blockly.Msg.TEXT_CHARAT_INPUT_INTEXT="in text";
Blockly.Msg.TEXT_CHARAT_LAST="get last letter";Blockly.Msg.TEXT_CHARAT_RANDOM="get random letter";Blockly.Msg.TEXT_CHARAT_TAIL="";Blockly.Msg.TEXT_CHARAT_TOOLTIP="Returns the letter at the specified position.";Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP="Add an item to the text.";Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN="join";Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP="Add, remove, or reorder sections to reconfigure this text block.";Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END="to letter # from end";
...
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL="";Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP="Returns a specified portion of the text.";Blockly.Msg.TEXT_INDEXOF_HELPURL="https://code.google.com/p/blockly/wiki/Text#Finding_text";Blockly.Msg.TEXT_INDEXOF_INPUT_INTEXT="in text";Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST="find first occurrence of text";Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST="find last occurrence of text";Blockly.Msg.TEXT_INDEXOF_TAIL="";Blockly.Msg.TEXT_INDEXOF_TOOLTIP="Returns the index of the first/last occurrence of first text in the second text.  Returns 0 if text is not found.";
Blockly.Msg.TEXT_ISEMPTY_HELPURL="https://code.google.com/p/blockly/wiki/Text#Checking_for_empty_text";Blockly.Msg.TEXT_ISEMPTY_TITLE="%1 is empty";Blockly.Msg.TEXT_ISEMPTY_TOOLTIP="Returns true if the provided text is empty.";Blockly.Msg.TEXT_JOIN_HELPURL="https://code.google.com/p/blockly/wiki/Text#Text_creation";Blockly.Msg.TEXT_JOIN_TITLE_CREATEWITH="create text with";Blockly.Msg.TEXT_JOIN_TOOLTIP="Create a piece of text by joining together any number of items.";
Blockly.Msg.TEXT_LENGTH_HELPURL="https://code.google.com/p/blockly/wiki/Text#Text_modification";Blockly.Msg.TEXT_LENGTH_TITLE="length of %1";Blockly.Msg.TEXT_LENGTH_TOOLTIP="Returns the number of letters (including spaces) in the provided text.";Blockly.Msg.TEXT_PRINT_HELPURL="https://code.google.com/p/blockly/wiki/Text#Printing_text";Blockly.Msg.TEXT_PRINT_TITLE="print %1";Blockly.Msg.TEXT_PRINT_TOOLTIP="Print the specified text, number or other value.";Blockly.Msg.TEXT_PROMPT_HELPURL="https://code.google.com/p/blockly/wiki/Text#Getting_input_from_the_user";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER="Prompt for user for a number.";Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT="Prompt for user for some text.";Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER="prompt for number with message";Blockly.Msg.TEXT_PROMPT_TYPE_TEXT="prompt for text with message";Blockly.Msg.TEXT_TEXT_HELPURL="https://en.wikipedia.org/wiki/String_(computer_science)";Blockly.Msg.TEXT_TEXT_TOOLTIP="A letter, word, or line of text.";Blockly.Msg.TEXT_TRIM_HELPURL="https://code.google.com/p/blockly/wiki/Text#Trimming_%28removing%29_spaces";
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH="trim spaces from both sides";Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT="trim spaces from left side";Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT="trim spaces from right side";Blockly.Msg.TEXT_TRIM_TOOLTIP="Return a copy of the text with spaces removed from one or both ends.";Blockly.Msg.VARIABLES_DEFAULT_NAME="item";Blockly.Msg.VARIABLES_GET_CREATE_SET="Create 'set %1'";Blockly.Msg.VARIABLES_GET_HELPURL="http://code.google.com/p/blockly/wiki/Variables#Get";
Blockly.Msg.VARIABLES_GET_TAIL="";Blockly.Msg.VARIABLES_GET_TITLE="";Blockly.Msg.VARIABLES_GET_TOOLTIP="Returns the value of this variable.";Blockly.Msg.VARIABLES_SET_CREATE_GET="Create 'get %1'";Blockly.Msg.VARIABLES_SET_HELPURL="http://code.google.com/p/blockly/wiki/Variables#Set";Blockly.Msg.VARIABLES_SET_TAIL="to";Blockly.Msg.VARIABLES_SET_TITLE="set";Blockly.Msg.VARIABLES_SET_TOOLTIP="Sets this variable to be equal to the input.";Blockly.Msg.PROCEDURES_DEFRETURN_TITLE=Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE;
Blockly.Msg.LISTS_GET_SUBLIST_INPUT_IN_LIST=Blockly.Msg.LISTS_INLIST;Blockly.Msg.LISTS_SET_INDEX_INPUT_IN_LIST=Blockly.Msg.LISTS_INLIST;Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE=Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE;Blockly.Msg.VARIABLES_SET_ITEM=Blockly.Msg.VARIABLES_DEFAULT_NAME;Blockly.Msg.LISTS_CREATE_WITH_ITEM_TITLE=Blockly.Msg.VARIABLES_DEFAULT_NAME;Blockly.Msg.MATH_CHANGE_TITLE_ITEM=Blockly.Msg.VARIABLES_DEFAULT_NAME;Blockly.Msg.VARIABLES_GET_ITEM=Blockly.Msg.VARIABLES_DEFAULT_NAME;
Blockly.Msg.PROCEDURES_DEFRETURN_DO=Blockly.Msg.PROCEDURES_DEFNORETURN_DO;Blockly.Msg.LISTS_GET_INDEX_HELPURL=Blockly.Msg.LISTS_INDEX_OF_HELPURL;Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TITLE_ITEM=Blockly.Msg.VARIABLES_DEFAULT_NAME;Blockly.Msg.CONTROLS_IF_MSG_THEN=Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;Blockly.Msg.LISTS_INDEX_OF_INPUT_IN_LIST=Blockly.Msg.LISTS_INLIST;Blockly.Msg.PROCEDURES_CALLRETURN_CALL=Blockly.Msg.PROCEDURES_CALLNORETURN_CALL;Blockly.Msg.LISTS_GET_INDEX_INPUT_IN_LIST=Blockly.Msg.LISTS_INLIST;
Blockly.Msg.CONTROLS_FOR_INPUT_DO=Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;Blockly.Msg.CONTROLS_FOREACH_INPUT_DO=Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;Blockly.Msg.CONTROLS_IF_IF_TITLE_IF=Blockly.Msg.CONTROLS_IF_MSG_IF;Blockly.Msg.CONTROLS_WHILEUNTIL_INPUT_DO=Blockly.Msg.CONTROLS_REPEAT_INPUT_DO;Blockly.Msg.CONTROLS_IF_ELSEIF_TITLE_ELSEIF=Blockly.Msg.CONTROLS_IF_MSG_ELSEIF;Blockly.Msg.TEXT_APPEND_VARIABLE=Blockly.Msg.VARIABLES_DEFAULT_NAME;Blockly.Msg.CONTROLS_IF_ELSE_TITLE_ELSE=Blockly.Msg.CONTROLS_IF_MSG_ELSE;Blockly.FieldNumberInput=function(a,b){Blockly.FieldNumberInput.superClass_.constructor.call(this,a);this.changeHandler_=b};goog.inherits(Blockly.FieldNumberInput,Blockly.FieldTextInput);
Blockly.FieldNumberInput.prototype.onHtmlInputChange_=function(a){var b=Blockly.FieldTextInput.htmlInput_;13==a.keyCode?(Blockly.WidgetDiv.hide(),Blockly.getMainWorkspace().fireChangeEvent()):27==a.keyCode?(this.setText(b.defaultValue),Blockly.getMainWorkspace().fireImmediateChangeEvent(),Blockly.WidgetDiv.hide()):(a=parseInt(b.value),isNaN(a)&&(a=0),this.range&&(a=Math.max(this.range.min,Math.min(this.range.max,a))),this.setText(""+a),Blockly.getMainWorkspace().fireImmediateChangeEvent(),this.validate_(),
goog.userAgent.WEBKIT&&this.sourceBlock_.render())};
Blockly.FieldNumberInput.prototype.showEditor_=function(){if(goog.userAgent.MOBILE){var a=parseInt(window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE,this.text_));isNaN(a)&&(a=0);this.range&&(a=Math.max(this.range.min,Math.min(this.range.max,a)));if(this.changeHandler_){var b=this.changeHandler_(a);void 0!==b&&(a=b)}null!==a&&this.setText(""+a)}else{Blockly.WidgetDiv.show(this,this.dispose_);var a=Blockly.WidgetDiv.DIV,c=goog.dom.createDom("input","blocklyHtmlInput");c.setAttribute("type","number");this.range&&
(c.setAttribute("min",this.range.min),c.setAttribute("max",this.range.max));Blockly.FieldTextInput.htmlInput_&&Blockly.unbindEvent_(Blockly.FieldTextInput.htmlInput_.onWorkspaceChangeWrapper_);Blockly.FieldTextInput.htmlInput_=c;var d=this,b=document.createElement("button");b.setAttribute("class","up");b.onclick=function(){var a=parseInt(c.value);isNaN(a)&&(a=0);c.value=a+1;d.range&&(c.value=Math.min(c.value,d.range.max));d.setText(c.value);Blockly.getMainWorkspace().fireImmediateChangeEvent()};var e=
document.createElement("button");e.setAttribute("class","down");e.onclick=function(){var a=parseInt(c.value);isNaN(a)&&(a=0);c.value=a-1;d.range&&(c.value=Math.max(c.value,d.range.min));d.setText(c.value);Blockly.getMainWorkspace().fireImmediateChangeEvent()};var f=document.createElement("div");f.setAttribute("class","with-arrows");f.appendChild(b);f.appendChild(c);f.appendChild(e);a.appendChild(f);c.value=c.defaultValue=this.text_;c.oldValue_=null;this.validate_();this.resizeEditor_();c.focus();
c.select();c.onKeyUpWrapper_=Blockly.bindEvent_(c,"keyup",this,this.onHtmlInputChange_);c.onKeyPressWrapper_=Blockly.bindEvent_(c,"keydown",this,this.onHtmlInputChange_);a=this.sourceBlock_.workspace.getCanvas();c.onWorkspaceChangeWrapper_=Blockly.bindEvent_(a,"blocklyWorkspaceChange",this,this.resizeEditor_)}};Blockly.RenderStrategies.HorizontalStrategy=function(a,b,c){var d=a.getRelativeToSurfaceXY();b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionTriangle("output");var e=b.getCurrentPosition();a.previousConnection.moveTo(d.x+e.x-Blockly.Builder.CONNECTION_TRIANGLE_INSET,d.y+e.y+Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT);b.drawHorizontallyTo(199);b.drawVerticallyBy(60);b.drawHorizontallyTo(0);b.closePath();for(var e=Blockly.Builder.DEFAULT_BLOCK_PADDING,f=0,g;g=a.inputList[f];f++){var d=
g.titleRow[0].getRootElement(),h=d.getBoundingClientRect().width;c.translate(d,e,34);h=e+h+Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH+10;b.moveTo(h,15);b.drawConnectionInlineTrapezoid();c.prepareConnection(g.connection,"InlineTrapezoid",h,15);d=a.getRelativeToSurfaceXY();console.log(d);c.moveAndTightenConnection(g,d.x+h,d.y+15+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2);e+=90}c.cutoutInlineInputs(a)};Blockly.RenderStrategies.horizontal=Blockly.RenderStrategies.HorizontalStrategy;Blockly.RenderStrategies.accessory=function(a,b,c){var d=a.desiredHeight,e=a.desiredWidth,f=a.getRelativeToSurfaceXY();b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionTriangle("output");var g=b.getCurrentPosition();a.previousConnection.moveTo(f.x+g.x-Blockly.Builder.CONNECTION_TRIANGLE_INSET,f.y+g.y+Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT);b.drawHorizontallyTo(e);b.drawVerticallyBy(d);b.drawHorizontallyTo(Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_TRIANGLE_WIDTH);
b.drawConnectionTriangle("input");g=b.getCurrentPosition();c.prepareConnection(a.nextConnection,"VerticalTriangle",g.x+Blockly.Builder.CONNECTION_TRIANGLE_WIDTH,g.y);a.nextConnection.moveTo(f.x+g.x+Blockly.Builder.CONNECTION_TRIANGLE_INSET,f.y+g.y+Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT);a.nextConnection.targetConnection&&a.nextConnection.tighten_();b.drawHorizontallyTo(0);b.closePath();for(var g=d=0,h;h=a.inputList[g];g++){var k=h.titleRow[0],l=k.textElement_,n;"head"==h.name?(h=Blockly.Builder.BLOCK_TITLE_INDENT,
n=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT,l.setAttribute("class","blocklyBlockSubtitle"),c.translate(k.getRootElement(),h,n)):"accessory"==h.name?(c.translate(k.fieldGroup_,10,45),c.adjustRectangle(k.borderRect_,0,0,125,20),c.adjustText(k.textElement_,5,10,"left")):h.type==Blockly.INPUT_VALUE&&(l=e-Blockly.Builder.DEFAULT_BLOCK_PADDING-Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH,n=Blockly.Builder.DEFAULT_BLOCK_PADDING+d,b.moveTo(l,n),b.drawConnectionInlineTrapezoid(),c.translate(k.getRootElement(),
l-Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH-Blockly.Builder.DEFAULT_BLOCK_PADDING-5,n+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2+4),c.prepareConnection(h.connection,"InlineTrapezoid",l,n),c.moveAndTightenConnection(h,f.x+l,f.y+n+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2),d+=Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT+Blockly.Builder.DEFAULT_BLOCK_PADDING)}c.cutoutInlineInputs(a)};Blockly.RenderStrategies.BackgroundStrategy=function(a,b,c){var d=a.desiredHeight,e=a.desiredWidth,f=a.getRelativeToSurfaceXY();b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionTrapezoid("vertical","output");var g=b.getCurrentPosition(),h=f.x+g.x-Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH/2,g=f.y+g.y+Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH;a.previousConnection?a.previousConnection.moveTo(h,g):a.outputConnection.moveTo(h,g);b.drawHorizontallyTo(e);b.drawVerticallyBy(d);a.nextConnection&&
(b.drawHorizontallyTo(Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH),b.drawConnectionTrapezoid("vertical","input",0),g=b.getCurrentPosition(),c.prepareConnection(a.nextConnection,"VerticalTrapezoid",g.x+Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH,g.y),a.nextConnection.moveTo(f.x+g.x+Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH/2,f.y+g.y+Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH),a.nextConnection.targetConnection&&a.nextConnection.tighten_());b.drawHorizontallyTo(0);b.closePath();
for(b=0;f=a.inputList[b];b++)d=f.titleRow[0],e=d.textElement_,"head"==f.name?(f=Blockly.Builder.BLOCK_TITLE_INDENT,h=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+5,e.setAttribute("class","blocklyBlockTitle"),c.translate(d.getRootElement(),f,h)):"source"==f.name?(c.translate(d.fieldGroup_,10,45),c.adjustRectangle(d.borderRect_,0,0,200,20),c.adjustText(e,5,10,"left")):"thumbnail"==f.name&&c.translate(d.fieldGroup_,10,75)};Blockly.RenderStrategies.background=Blockly.RenderStrategies.BackgroundStrategy;Blockly.RenderStrategies.beats=function(a,b,c){var d=a.desiredWidth,e=a.getRelativeToSurfaceXY(),f,g;b.drawHorizontallyTo(d);b.drawVerticallyBy(2*Blockly.Builder.BLOCK_TITLE_HEIGHT);b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH+Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH);b.drawConnectionDoubleBox("input");f=b.getCurrentPosition();c.prepareConnection(a.inputList[2].connection,"DoubleBox",f.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH,f.y);g=e.x+f.x+
Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH/2;f=e.y+f.y+Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT;c.moveAndTightenConnection(a.inputList[2],g,f);b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH);g=350;a.inputList[2].connection.targetConnection&&(g=c.getRowHeight(a.inputList[2]),g+=Blockly.Builder.BLOCK_GUTTER_BOTTOM_PADDING);b.drawStatementGutter(g,"doublebox");b.drawHorizontallyTo(d);b.drawVerticallyBy(Blockly.Builder.BLOCK_ARM_HEIGHT);b.drawHorizontallyTo(0);b.closePath();g=d-Blockly.Builder.DEFAULT_BLOCK_PADDING-
Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH;f=25;b.moveTo(g,f);b.drawConnectionInlineTrapezoid();c.prepareConnection(a.inputList[1].connection,"InlineTrapezoid",g,f);c.moveAndTightenConnection(a.inputList[1],e.x+g,e.y+f);c.cutoutInlineInputs(a);for(g=0;f=a.inputList[g];g++){var h=f.titleRow[0],k=h.textElement_,l=h.getSize().width,n,m,q;"head"==f.name?(m=Blockly.Builder.BLOCK_TITLE_INDENT,q=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT,n="blocklyBlockTitle"):f.type==Blockly.INPUT_VALUE?(m=d/2-l/2,q=
45,n="blocklyBlockSubtitle"):f.type==Blockly.NEXT_STATEMENT&&(m=d/2-l/2,f.connection.targetConnection?(m=d/2-l/2+8,q=e.y+2*Blockly.Builder.BLOCK_TITLE_HEIGHT+c.getRowHeight(f)-5,k.innerHTML="MORE MEASURES?"):(q=b.getCurrentPosition().y-Blockly.Builder.BLOCK_ARM_HEIGHT+235+k.clientHeight/2,k.innerHTML="ADD MEASURE BLOCK"),n="blocklyBlockLabel");k.setAttribute("class",n);c.translate(h.getRootElement(),m,q)}};Blockly.RenderStrategies.ChallengeStrategy=function(a,b,c){var d=a.desiredHeight,e=a.desiredWidth,f=a.getRelativeToSurfaceXY();b.drawHorizontallyTo(e);b.drawVerticallyBy(Blockly.Builder.BLOCK_TITLE_HEIGHT);for(var g=0,h;h=a.inputList[g];g++){var k,l;h.type==Blockly.INPUT_VALUE?(b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH+Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH),b.drawConnectionTrapezoid("vertical","input"),k=b.getCurrentPosition(),c.prepareConnection(h.connection,
"VerticalTrapezoid",k.x+Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH,k.y),l=f.x+k.x+Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH/2,k=f.y+k.y+Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH,c.moveAndTightenConnection(h,l,k),b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH),b.drawVerticallyBy(d),b.drawHorizontallyTo(e),b.drawVerticallyBy(Blockly.Builder.BLOCK_ARM_HEIGHT)):h.type==Blockly.NEXT_STATEMENT&&("avatar"==a.desiredStrategy?(b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH+Blockly.Builder.CONNECTION_INDENT+
Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH),b.drawConnectionDoubleBox("input"),k=b.getCurrentPosition(),c.prepareConnection(h.connection,"DoubleBox",k.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH,k.y),l=f.x+k.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH/2,k=f.y+k.y+Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT):(b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH+Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_TRIANGLE_WIDTH),b.drawConnectionTriangle("input"),k=b.getCurrentPosition(),
c.prepareConnection(h.connection,"VerticalTriangle",k.x+Blockly.Builder.CONNECTION_TRIANGLE_WIDTH,k.y),l=f.x+k.x+Blockly.Builder.CONNECTION_TRIANGLE_INSET,k=f.y+k.y+Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT),c.moveAndTightenConnection(h,l,k),b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH),"nexus-challenge"==a.desiredStrategy||"art"==a.desiredStrategy?l=h.connection.targetConnection&&1<=a.getDescendants().length?c.getRowHeight(h)+7:d:(l="gif"==a.desiredStrategy?560:"avatar"==a.desiredStrategy||
"bracelet"==a.desiredStrategy?d:Blockly.Builder.BLOCK_DEFAULT_GUTTER_HEIGHT,h.connection.targetConnection&&(l=c.getRowHeight(h),"gif"!=a.desiredStrategy&&(l="bracelet"==a.desiredStrategy&&1<=a.getDescendants().length?c.getRowHeight(h)+7:l+Blockly.Builder.BLOCK_GUTTER_BOTTOM_PADDING))),"gif"==a.desiredStrategy?b.drawVerticallyBy(l,"triangle"):"avatar"==a.desiredStrategy?b.drawStatementGutter(l,"doublebox"):b.drawStatementGutter(l,"triangle"),b.drawHorizontallyTo(e),b.drawVerticallyBy(Blockly.Builder.BLOCK_ARM_HEIGHT))}b.drawHorizontallyTo(0);
b.closePath();for(g=0;h=a.inputList[g];g++){f=h.titleRow[0];l=f.textElement_;k=f.getSize().width;var n,m,q;if("head"==h.name)m=Blockly.Builder.BLOCK_TITLE_INDENT,q=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT,n="blocklyBlockTitle";else if(h.type==Blockly.INPUT_VALUE)m=e/2-k/2,q=Blockly.Builder.CHALLENGE_BLOCK_TITLE_HEIGHT+d/2-l.clientHeight/2,n="blocklyBlockLabel";else if(h.type==Blockly.NEXT_STATEMENT){m=e/2-k/2-10;if(h.connection.targetConnection)if(q=b.getCurrentPosition().y-Blockly.Builder.BLOCK_ARM_HEIGHT-
Blockly.Builder.DEFAULT_BLOCK_PADDING/2,"selfie"==a.desiredStrategy)l.innerHTML="MORE ACCESSORIES?",m+=2*Blockly.Builder.DEFAULT_BLOCK_PADDING;else if("avatar"==a.desiredStrategy)l.innerHTML="MORE SHAPES?",m+=2*Blockly.Builder.DEFAULT_BLOCK_PADDING;else{if("bracelet"==a.desiredStrategy||"art"==a.desiredStrategy)l.innerHTML=""}else q="gif"==a.desiredStrategy?b.getCurrentPosition().y-Blockly.Builder.BLOCK_ARM_HEIGHT-280+l.clientHeight/2:"art"==a.desiredStrategy?b.getCurrentPosition().y-Blockly.Builder.BLOCK_ARM_HEIGHT-
175+l.clientHeight/2:"avatar"==a.desiredStrategy||"bracelet"==a.desiredStrategy?b.getCurrentPosition().y-Blockly.Builder.BLOCK_ARM_HEIGHT-d/2+l.clientHeight/2:b.getCurrentPosition().y-Blockly.Builder.BLOCK_ARM_HEIGHT-Blockly.Builder.BLOCK_DEFAULT_GUTTER_HEIGHT/2+l.clientHeight/2,"selfie"==a.desiredStrategy?l.innerHTML="ADD ACCESSORIES BLOCKS":"avatar"==a.desiredStrategy?l.innerHTML="ADD SHAPE BLOCK":"bracelet"==a.desiredStrategy?l.innerHTML="ADD PROPERTIES BLOCK":"art"==a.desiredStrategy&&(l.innerHTML=
"ADD KALEIDOSCOPE BLOCK");n="blocklyBlockLabel"}l.setAttribute("class",n);c.translate(f.getRootElement(),m,q)}};Blockly.RenderStrategies["nexus-challenge"]=Blockly.RenderStrategies.art=Blockly.RenderStrategies.selfie=Blockly.RenderStrategies.gif=Blockly.RenderStrategies.avatar=Blockly.RenderStrategies.bracelet=Blockly.RenderStrategies.fashion=Blockly.RenderStrategies.ChallengeStrategy;Blockly.RenderStrategies.color_picker=function(a,b,c){var d=Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT,e=Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH,f=Blockly.Builder.DEFAULT_BLOCK_PADDING/2,g=a.getRelativeToSurfaceXY();b.drawConnectionInlineBox();c.adjustRectangle(a.inputList[0].titleRow[0].borderRect_,2*f,f,e-3*f,d-2*f);a.outputConnection.moveTo(g.x,g.y+d/2)};Blockly.RenderStrategies.frame=function(a,b,c){var d=a.desiredHeight,e=a.desiredWidth,f=a.getRelativeToSurfaceXY();b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionTriangle("output");var g=b.getCurrentPosition();a.previousConnection.moveTo(f.x+g.x-Blockly.Builder.CONNECTION_TRIANGLE_INSET,f.y+g.y+Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT);b.drawHorizontallyTo(e);b.drawVerticallyBy(Blockly.Builder.BLOCK_TITLE_HEIGHT);var h,k,l;k=0;for(var g=d,n=0,m;m=a.inputList[n];n++){var q=
m.titleRow[0],s=q.textElement_;h=q.getSize().width;m.type==Blockly.DUMMY_INPUT?(h=Blockly.Builder.BLOCK_TITLE_INDENT,k="head1"==m.name?Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT:k+(Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+g+15),m="blocklyBlockTitle",s.setAttribute("class",m),c.translate(q.getRootElement(),h,k)):m.type==Blockly.NEXT_STATEMENT&&(b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH+Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH),b.drawConnectionDoubleBox("input"),
g=b.getCurrentPosition(),c.prepareConnection(m.connection,"DoubleBox",g.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH,g.y),c.moveAndTightenConnection(m,f.x+g.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH/2,f.y+g.y+Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT),b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH),l=d,g=m.connection.targetConnection?l=c.getRowHeight(m)+Blockly.Builder.BLOCK_GUTTER_BOTTOM_PADDING:d,b.drawVerticallyBy(l),b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT),
b.drawConnectionDoubleBox("output"),b.drawHorizontallyTo(e),b.drawVerticallyBy(Blockly.Builder.BLOCK_TITLE_HEIGHT),h=e/2-h/2,m.connection.targetConnection?(l=b.getCurrentPosition().y-Blockly.Builder.BLOCK_TITLE_HEIGHT-Blockly.Builder.DEFAULT_BLOCK_PADDING/2,s.innerHTML="MORE DOODLES?"):(l=b.getCurrentPosition().y-Blockly.Builder.BLOCK_TITLE_HEIGHT-d/2+s.clientHeight/2,s.innerHTML="ADD DOODLE BLOCK"),m="blocklyBlockLabel",s.setAttribute("class",m),c.translate(q.getRootElement(),h,l))}b.drawHorizontallyTo(0);
b.closePath()};Blockly.RenderStrategies.measure=function(a,b,c){var d=a.desiredHeight,e=a.desiredWidth,f=a.getRelativeToSurfaceXY(),g;b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionDoubleBox("output");g=b.getCurrentPosition();a.previousConnection.moveTo(f.x+g.x-Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH/2,f.y+g.y+Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT);b.drawHorizontallyTo(e);b.drawVerticallyBy(d);b.drawHorizontallyTo(Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH);
b.drawConnectionDoubleBox("input");g=b.getCurrentPosition();c.prepareConnection(a.nextConnection,"DoubleBox",g.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH,g.y);a.nextConnection.moveTo(f.x+g.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH/2,f.y+g.y+Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT);a.nextConnection.targetConnection&&a.nextConnection.tighten_();b.drawHorizontallyTo(0);b.closePath();for(b=0;d=a.inputList[b];b++){g=d.titleRow[0];var h=g.textElement_,k;if("head"==d.name)e=Blockly.Builder.BLOCK_TITLE_INDENT,
f=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+5,k="blocklyBlockTitle",h.setAttribute("class",k),c.translate(g.getRootElement(),e,f);else for(e=Blockly.Builder.BLOCK_TITLE_INDENT,f=(Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+20)*(b+1),k="blocklyBlockSubtitle",h.setAttribute("class",k),c.translate(g.getRootElement(),e,f-27),e-=21,g=1;h=d.titleRow[g];g++)k=h.getRootElement(),h.textElement_.getBBox(),k.className+=" note",e+=26,c.translate(k,e-7,f-20)}};Blockly.RenderStrategies.MoveStrategy=function(a,b,c){var d=a.getRelativeToSurfaceXY();b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionTrapezoid("vertical","output");var e=b.getCurrentPosition(),f=d.x+e.x-Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH/2,e=d.y+e.y+Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH;a.previousConnection?a.previousConnection.moveTo(f,e):a.outputConnection.moveTo(f,e);b.drawHorizontallyTo(200);b.drawVerticallyBy(60);a.nextConnection&&(b.drawHorizontallyTo(Blockly.Builder.CONNECTION_INDENT+
Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH),b.drawConnectionTrapezoid("vertical","input"),e=b.getCurrentPosition(),c.prepareConnection(a.nextConnection,"VerticalTrapezoid",e.x+Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH,e.y),a.nextConnection.moveTo(d.x+e.x+Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH/2,d.y+e.y+Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH),a.nextConnection.targetConnection&&a.nextConnection.tighten_());b.drawHorizontallyTo(0);b.closePath();for(var f=Blockly.Builder.DEFAULT_BLOCK_PADDING,
e=0,g;g=a.inputList[e];e++){var d=g.titleRow[0],h=d.getRootElement(),k=h.getBoundingClientRect().width,l=d.textElement_;"direction"==g.name?(c.translate(d.fieldGroup_,f,33),c.adjustRectangle(d.borderRect_,f+22,-12,55,20),c.adjustText(l,f+30,-4,"left"),f+=90):"label"==g.name?c.adjustText(l,4,31,"left"):(f+=6,c.translate(h,f+4,34),h=f+k+Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH+10,b.moveTo(h,14),b.drawConnectionInlineTrapezoid(),c.prepareConnection(g.connection,"InlineTrapezoid",h,14),d=a.getRelativeToSurfaceXY(),
c.moveAndTightenConnection(g,d.x+h,d.y+14+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2),f+=90)}c.cutoutInlineInputs(a)};Blockly.RenderStrategies.move=Blockly.RenderStrategies.MoveStrategy;Blockly.RenderStrategies.NexusStrategy=function(a,b,c){var d=a.desiredHeight,e=a.desiredWidth,f,g,h=Blockly.Builder.BLOCK_TITLE_HEIGHT/2,k=Blockly.Builder.BLOCK_TITLE_INDENT,l=e-Blockly.Builder.DEFAULT_BLOCK_PADDING-Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH,n=a.getRelativeToSurfaceXY(),m=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+5,q,s={draw:b.drawConnectionTriangle,height:Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT,inset:Blockly.Builder.CONNECTION_TRIANGLE_INSET,strategy:"VerticalTriangle",width:Blockly.Builder.CONNECTION_TRIANGLE_WIDTH},
x={draw:function(a){b.drawConnectionTrapezoid("vertical",a)},height:Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH,inset:Math.round(Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH/2)-1,strategy:"VerticalTrapezoid",width:Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH},v={draw:function(){b.drawConnectionInlineBox()},height:Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT,inset:Math.round(Blockly.Builder.CONNECTION_BOX_HEIGHT/2),strategy:"InlineBox",width:Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH},p={draw:function(){b.drawConnectionInlineTrapezoid()},
height:Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT,inset:Math.round(Blockly.Builder.CONNECTION_TRAPEZOID_WIDTH/2),strategy:"InlineTrapezoid",width:Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH},s={1:s,2:x,3:v,4:p,5:{draw:function(a){b.drawConnectionBox("vertical",a)},inset:Blockly.Builder.CONNECTION_BOX_INSET,height:Blockly.Builder.CONNECTION_BOX_HEIGHT,width:Blockly.Builder.CONNECTION_BOX_HEIGHT,strategy:"VerticalBox"},6:{draw:function(a){b.drawConnectionDoubleBox(a)},inset:Blockly.Builder.CONNECTION_BOX_INSET,
height:Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT,width:Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH,strategy:"DoubleBox"}},w={getRowTitle:function(a){if(null==a||null==a.titleRow||1>a.titleRow.length)return null;a=a.titleRow[0];return null==a?null:a.getText()}},t=1,u=!1,x=function(a,b){a.innerHTML=a.innerText=a.textContent=b};if(a.inputList&&0<a.inputList.length)for(v=0;v<a.inputList.length;v++)p=a.inputList[v].name,0==p.indexOf("__connectionType:")?(g=p.split(":"),1<g.length&&(t=Number(g[1]))):
"__smallTails"==p&&(u=!0);a.previousConnection&&(b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT),s[t].draw("output"),f=b.getCurrentPosition(),g=n.x+f.x-s[t].inset,f=n.y+f.y+s[t].height,a.previousConnection.moveTo(g,f));b.drawHorizontallyTo(e);b.drawHorizontallyTo(e);b.drawVerticallyBy(h);for(v=0;p=a.inputList[v];v++)if(0!=p.name.indexOf("__")){var r=2;g=p.name.split(":");1<g.length&&(r=Number(g[1]));if(p.type==Blockly.NEXT_STATEMENT||p.type==Blockly.INPUT_VALUE&&0==p.name.indexOf("IMAGE")){q=
w.getRowTitle(p);null!=q&&""!=q&&" "!=q&&b.drawVerticallyBy(h+("logic_if_can_turn"===a.type?-10:0));b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH+Blockly.Builder.CONNECTION_INDENT+s[r].width);s[r].draw("input");f=b.getCurrentPosition();c.prepareConnection(p.connection,s[r].strategy,f.x+s[r].width,f.y);g=n.x+f.x+s[r].inset;f=n.y+f.y+s[r].height;c.moveAndTightenConnection(p,g,f);b.drawHorizontallyTo(Blockly.Builder.BLOCK_BACK_WIDTH);q=40;p.connection.targetConnection&&1<=a.getDescendants().length&&
(q=p.connection.targetBlock(),null!=q&&null!=q.nextConnection?(q=c.getRowHeight(p)+7,"MOVE"===p.name?q-=15:a&&"fashion"===a.type&&"DO:1"===p.name&&"logic_if_can_turn"!==a.type&&(q+=25)):q=c.getRowHeight(p)+-3);switch(p.name){case "DO:1":case "ACTIONS:1":q+="robots"!==a.type&&"games"!==a.type&&"maps"!==a.type&&"logic_repeat"!==a.type&&"logic_if_needs_water"!==a.type&&"logic_if_can_turn"!==a.type||p.connection.targetConnection?0:20;"fashion"===a.type&&(q+=p.connection.targetConnection?0:310);break;
case "ACTIONS":q+=15;break;case "IMAGE":q="kaleidoscope"===a.type?q+(p.connection.targetConnection?30:245):q+30;break;case "RINGS:1":q+=p.connection.targetConnection?30:200;break;case "YETI:1":q=220;break;case "DANCE:1":q=p.connection.targetConnection?q+30:340;break;case "MOVE":"fashion_circle"!==a.type||p.connection.targetConnection||(q=60);break;case "JOINT:2":case "SHAPE:1":case "JOINT1:2":case "JOINT2:2":case "START_POSITION:1":case "SHAPE":q=60}b.drawVerticallyBy(q);q=b.getCurrentPosition().y-
Blockly.Builder.BLOCK_TITLE_HEIGHT-Blockly.Builder.DEFAULT_BLOCK_PADDING/2;!0==u?b.drawHorizontallyTo(e/2):b.drawHorizontallyTo(e);b.drawVerticallyBy(Blockly.Builder.BLOCK_ARM_HEIGHT)}else{if(p.type==Blockly.DUMMY_INPUT||p.type==Blockly.INPUT_VALUE)console.log("again",a.type,p.name),"games_turn"===a.type||"actions_turn"===a.type||"move"===a.type||"tracer"===a.type&&"PATTERN_SIZE:4"===p.name?b.drawVerticallyBy(0):"logic_if_can_turn"===a.type?b.drawVerticallyBy(18):b.drawVerticallyBy(40);("field"==
p.name||0==p.name.indexOf("field:"))&&1<p.titleRow.length&&b.drawVerticallyBy(40)}}f=b.getCurrentPosition();f.y<d&&b.drawVerticallyBy(d-f.y);a.nextConnection&&(b.drawHorizontallyTo(Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_TRIANGLE_WIDTH),s[t].draw("input"),f=b.getCurrentPosition(),c.prepareConnection(a.nextConnection,s[t].strategy,f.x+s[t].width,f.y),a.nextConnection.moveTo(n.x+f.x+s[t].width/2,n.y+f.y+s[t].height),a.nextConnection.targetConnection&&a.nextConnection.tighten_());
b.drawHorizontallyTo(0);b.closePath();h=null;for(v=0;p=a.inputList[v];v++)if(w=40,0==p.name.indexOf("__"))h=null;else{d=p.titleRow[0];e=d.textElement_;r=!1;p.type==Blockly.NEXT_STATEMENT?r=!0:p.type==Blockly.INPUT_VALUE&&0==p.name.indexOf("IMAGE")&&(r=!0);if("head"==p.name&&p.type==Blockly.DUMMY_INPUT)e.setAttribute("class","blocklyBlockTitle");else if(0<=p.name.indexOf("vspace"))g=p.name.split(":"),r=1<g.length?parseInt(g[1],10):100,m+=r;else if("field"==p.name||0==p.name.indexOf("field:"))g=p.name.split(":"),
r=1<g.length?Number(g[1]):100,t=0,u=-10,g=d,1<p.titleRow.length&&(w+=40,g=p.titleRow[1],c.translate(g.getRootElement(),k,m+20)),console.log("nexus",a.type),"games_turn"===a.type||"actions_turn"===a.type?(t=70,u=-30):"move"===a.type?u=-28:"logic_if_can_turn"===a.type&&(u=-20),"logic_if_can_turn"===a.type&&"field:45"===p.name&&(t=130,u=-55),c.adjustRectangle(g.borderRect_,t,u,r,20),c.adjustText(g.textElement_,t+5,u+10,"left");else if(p.type==Blockly.INPUT_VALUE&&!r)r=4,g=p.name.split(":"),1<g.length&&
(r=Number(g[1])),g=l,f=m+-18,console.log("nexus",a.type,p.name),"MOVE_VALUE"===p.name&&(f-=75),"tracer"===a.type&&"PATTERN_COLOR:3"===p.name&&(g-=110),"tracer"===a.type&&"PATTERN_SIZE:4"===p.name&&(f-=40),b.moveTo(g,f),s[r].draw(),c.prepareConnection(p.connection,s[r].strategy,g,f),c.moveAndTightenConnection(p,n.x+g,n.y+f+s[r].height/2);else if(p.type===Blockly.NEXT_STATEMENT&&r&&h&&p.sourceBlock_===h)r=h.childBlocks_.length,t=1<r?3:2,1===r&&p.connection.targetConnection&&p.connection.targetConnection.sourceBlock_!==
h.childBlocks_[0]&&(t=3),m+=w*t>>1;else if(p.type===Blockly.NEXT_STATEMENT){r=x.bind(null,e);if(p.connection.targetConnection){if("ACTIONS"==p.name||"DANCE:1"==p.name||"IMAGE"==p.name||"RINGS:1"==p.name||"DO:1"==p.name&&"logic_if_can_turn"!==a.type)titleClass="blocklyBlockLabel",e.setAttribute("class",titleClass),m=b.getCurrentPosition().y-Blockly.Builder.BLOCK_ARM_HEIGHT-Blockly.Builder.DEFAULT_BLOCK_PADDING/2,k=30,"ACTIONS"==p.name&&r("ADD MORE ACTIONS?"),"DANCE:1"==p.name&&r("ADD MORE GENERATORS?"),
"IMAGE"==p.name&&(r("ADD MORE IMAGES?"),m=q+38),"RINGS:1"==p.name&&r("ADD MORE SOUND RINGS?"),a&&"fashion"===a.type&&"DO:1"==p.name&&r("ADD MORE CIRCLES?")}else"ACTIONS"!=p.name&&"DANCE:1"!=p.name&&"RINGS:1"!=p.name&&"IMAGE"!=p.name||r(""),"kaleidoscope"===a.type&&"IMAGE"===p.name&&(w+=270);"SHAPE"==p.name&&(w+=65)}t=r=0;d&&0<=d.text_.indexOf("|")&&(u=d.text_.split("|"),t+=parseInt(u[1]),2<u.length&&(r+=parseInt(u[2])),x(e,u[0]));if("games_turn"===a.type||"actions_turn"===a.type)t=5;"logic_if_can_turn"===
a.type&&"IF_TURN_DO"===p.name&&(t=-50);"kaleidoscope"===a.type&&("ROTATION_SPEED"===p.name||"PATTERN_SIZE"===p.name)&&a.inputList[3]&&a.inputList[3].connection&&a.inputList[3].connection.targetConnection&&(r-=20);c.translate(d.getRootElement(),k+r,m+t);m+=w}c.cutoutInlineInputs(a)};Blockly.RenderStrategies.nexus=Blockly.RenderStrategies.NexusStrategy;Blockly.RenderStrategies.number=function(a,b,c){var d=Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT,e=Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH,f=Blockly.Builder.DEFAULT_BLOCK_PADDING/2,g=a.getRelativeToSurfaceXY();b.drawConnectionInlineTrapezoid();b=a.inputList[0].titleRow[0];c.adjustRectangle(b.borderRect_,f,f,e-2*f,d-2*f);c.adjustText(b.textElement_,e/2,d/2);a.outputConnection.moveTo(g.x,g.y+d/2)};Blockly.RenderStrategies.parameters=function(a,b,c){var d=a.desiredHeight,e=a.desiredWidth,f=a.getRelativeToSurfaceXY();b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionTriangle("output");var g=b.getCurrentPosition();a.previousConnection.moveTo(f.x+g.x-Blockly.Builder.CONNECTION_TRIANGLE_INSET,f.y+g.y+Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT);b.drawHorizontallyTo(e);b.drawVerticallyBy(d);b.drawHorizontallyTo(Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_TRIANGLE_WIDTH);
b.drawConnectionTriangle("input");g=b.getCurrentPosition();c.prepareConnection(a.nextConnection,"VerticalTriangle",g.x+Blockly.Builder.CONNECTION_TRIANGLE_WIDTH,g.y);a.nextConnection.moveTo(f.x+g.x+Blockly.Builder.CONNECTION_TRIANGLE_INSET,f.y+g.y+Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT);a.nextConnection.targetConnection&&a.nextConnection.tighten_();b.drawHorizontallyTo(0);b.closePath();for(d=0;g=a.inputList[d];d++){var h=g.titleRow[0],k=h.textElement_,l,n,m;log("DRAWING");g.type==Blockly.DUMMY_INPUT?
("titleDiameter"==g.name?(l=Blockly.Builder.BLOCK_TITLE_INDENT,n=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+5):"titleWidth"==g.name?(l=Blockly.Builder.BLOCK_TITLE_INDENT,n=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+45):"titleMessage"==g.name?(l=Blockly.Builder.BLOCK_TITLE_INDENT,n=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+85):"titleColor"==g.name&&(l=Blockly.Builder.BLOCK_TITLE_INDENT,n=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT+155),k.setAttribute("class","blocklyBlockTitle"),c.translate(h.getRootElement(),
l,n)):g.type==Blockly.INPUT_VALUE&&(k=e-Blockly.Builder.DEFAULT_BLOCK_PADDING-Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH,"WIDTH"==g.name?(m=Blockly.Builder.DEFAULT_BLOCK_PADDING,b.moveTo(k,m),b.drawConnectionInlineTrapezoid(),c.prepareConnection(g.connection,"InlineTrapezoid",k,m)):"DIAMETER"==g.name?(m=Blockly.Builder.DEFAULT_BLOCK_PADDING+40,b.moveTo(k,m),b.drawConnectionInlineTrapezoid(),c.prepareConnection(g.connection,"InlineTrapezoid",k,m)):"MESSAGE"==g.name?(k=Blockly.Builder.BLOCK_BACK_WIDTH+
10,m=Blockly.Builder.DEFAULT_BLOCK_PADDING+110,b.moveTo(k,m),b.drawConnectionInlineString(),c.prepareConnection(g.connection,"InlineString",k,m)):"COLOR"==g.name&&(m=Blockly.Builder.DEFAULT_BLOCK_PADDING+150,b.moveTo(k,m),b.drawConnectionInlineBox(),c.prepareConnection(g.connection,"InlineBox",k,m)),c.moveAndTightenConnection(g,f.x+k,f.y+m+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2),c.translate(h.getRootElement(),k-Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH-4*Blockly.Builder.DEFAULT_BLOCK_PADDING,
m+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2+4))}c.cutoutInlineInputs(a)};Blockly.RenderStrategies.ShapeStrategy=function(a,b,c){var d=a.desiredWidth,e=a.desiredHeight,f=a.getRelativeToSurfaceXY();b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionDoubleBox("output");var g=b.getCurrentPosition(),h=f.x+g.x-Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH/2,k=f.y+g.y+Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT;a.previousConnection.moveTo(h,k);b.drawHorizontallyTo(d);b.drawVerticallyBy(e);b.drawHorizontallyTo(Blockly.Builder.CONNECTION_INDENT+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH);
b.drawConnectionDoubleBox("input");g=b.getCurrentPosition();c.prepareConnection(a.nextConnection,"DoubleBox",g.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH,g.y);a.nextConnection.moveTo(f.x+g.x+Blockly.Builder.CONNECTION_DOUBLEBOX_TRUE_WIDTH/2,f.y+g.y+Blockly.Builder.CONNECTION_DOUBLEBOX_HEIGHT);a.nextConnection.targetConnection&&a.nextConnection.tighten_();b.drawHorizontallyTo(0);b.closePath();for(var e=30,g=0,l;l=a.inputList[g];g++){var n=l.titleRow[0],h=n.textElement_;"head"==l.name?(k=Blockly.Builder.BLOCK_TITLE_INDENT,
l=Blockly.Builder.BLOCK_TITLE_LINE_HEIGHT,h.setAttribute("class","blocklyBlockSubtitle"),c.translate(n.getRootElement(),k,l)):"title"==l.name?(c.translate(n.fieldGroup_,10,45),c.adjustRectangle(n.borderRect_,0,0,100,20),c.adjustText(n.textElement_,5,10,"left")):"thumbnail"==l.name?c.translate(n.fieldGroup_,10,75):l.type==Blockly.INPUT_VALUE&&(h=d-Blockly.Builder.DEFAULT_BLOCK_PADDING-Blockly.Builder.CONNECTION_INLINE_DEFAULT_WIDTH,k=Blockly.Builder.DEFAULT_BLOCK_PADDING+e,b.moveTo(h,k),"COLOR"==l.name?
(b.drawConnectionInlineBox(),c.prepareConnection(l.connection,"InlineBox",h,k)):(b.drawConnectionInlineTrapezoid(),c.prepareConnection(l.connection,"InlineTrapezoid",h,k)),c.moveAndTightenConnection(l,f.x+h,f.y+k+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2),"color:"==n.text_||"size:"==n.text_?(l="color:"==n.text_?25:20,c.translate(n.getRootElement(),h-Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH-Blockly.Builder.DEFAULT_BLOCK_PADDING-l,k+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2+4)):
c.translate(n.getRootElement(),h-Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH-Blockly.Builder.DEFAULT_BLOCK_PADDING-5,k+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2+4),e+=Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT+Blockly.Builder.DEFAULT_BLOCK_PADDING)}c.cutoutInlineInputs(a)};Blockly.RenderStrategies.shape=Blockly.RenderStrategies.ShapeStrategy;Blockly.RenderStrategies.StartStrategy=function(a,b,c){var d=a.getRelativeToSurfaceXY();b.drawHorizontallyBy(Blockly.Builder.CONNECTION_INDENT);b.drawConnectionTriangle("output");var e=b.getCurrentPosition(),f=d.x+e.x-Blockly.Builder.CONNECTION_TRIANGLE_WIDTH/2,d=d.y+e.y+Blockly.Builder.CONNECTION_TRIANGLE_HEIGHT;a.previousConnection?a.previousConnection.moveTo(f,d):a.outputConnection.moveTo(f,d);b.drawHorizontallyTo(199);b.drawVerticallyBy(60);b.drawHorizontallyTo(0);b.closePath();b.closePath();
for(var f=Blockly.Builder.DEFAULT_BLOCK_PADDING+8,e=0,g;g=a.inputList[e];e++){var d=g.titleRow[0].getRootElement(),h=d.getBoundingClientRect().width;c.translate(d,f,34);h=f+h+Blockly.Builder.CONNECTION_TRAPEZOID_DEPTH+10;b.moveTo(h,15);b.drawConnectionInlineTrapezoid();c.prepareConnection(g.connection,"InlineTrapezoid",h,15);d=a.getRelativeToSurfaceXY();c.moveAndTightenConnection(g,d.x+h,d.y+15+Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT/2);f+=105}c.cutoutInlineInputs(a)};
Blockly.RenderStrategies.start=Blockly.RenderStrategies.StartStrategy;Blockly.RenderStrategies.text=function(a,b,c){var d=Blockly.Builder.CONNECTION_INLINE_DEFAULT_HEIGHT,e=Blockly.Builder.DEFAULT_STRING_BLOCK_WIDTH,f=Blockly.Builder.DEFAULT_BLOCK_PADDING/2,g=a.getRelativeToSurfaceXY();b.drawConnectionInlineString();b=a.inputList[0].titleRow[0];c.adjustRectangle(b.borderRect_,f,f,e-2*f,d-2*f);c.adjustText(b.textElement_,e/2,d/2);a.outputConnection.moveTo(g.x,g.y+d/2)};
