...
/**
* Save Python generated code to local file.
*/
function saveCode() {
  var fileName = window.prompt('What would you like to name your mod?', 'minecraftPiMod')
...
function uploadCode(code, callback) {
    var target = document.getElementById('content_python');
...
function uploadClick() {
    var code = document.getElementById('content_python').value;
